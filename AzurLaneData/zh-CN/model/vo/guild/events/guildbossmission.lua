...
slot0.Ctor = function (slot0, slot1, slot2, slot3)
	...
	slot0.fleets = {
		[slot0.MAIN_FLEET_ID] = GuildBossMissionFleet.New({
			fleet_id = slot0.MAIN_FLEET_ID
		}),
		[slot0.SUB_FLEET_ID] = GuildBossMissionFleet.New({
			fleet_id = slot0.SUB_FLEET_ID
		})
	}
...
slot0.GetMainFleet = function (slot0)
	return slot0.fleets[slot0.MAIN_FLEET_ID]
end

slot0.GetSubFleet = function (slot0)
	return slot0.fleets[slot0.SUB_FLEET_ID]
end
