...
slot0.Ctor = function (slot0, slot1)
	...
	for slot6, slot7 in ipairs(slot1.nodes) do
		slot8 = nil
		slot8 = (slot7.status ~= 1 or Clone(pg.guild_event_node[slot7.id]).success_award) and Clone(pg.guild_event_node[slot7.id]).fail_award
...
slot0.IsPerfectFinish = function (slot0)
	return slot0.score == slot0.SCORE_TYPE_S
end

slot0.GetSelfDrop = function (slot0)
	if slot0.score == slot0.SCORE_TYPE_S then
