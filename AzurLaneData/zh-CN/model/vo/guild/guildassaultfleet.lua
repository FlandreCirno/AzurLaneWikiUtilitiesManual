...
slot0.IsSameUserId = function (slot0, slot1)
	return slot0:GetUserId() == slot0.GetUserId(slot1)
end
...
slot0.InitShips = function (slot0, slot1, slot2)
	...
	for slot6, slot7 in pairs(slot2) do
		slot7.id = slot0.GetVirtualId(slot0.userId, slot7.id)
...
slot0.SetRecommendList = function (slot0, slot1)
	for slot5, slot6 in ipairs(slot0.ships) do
		slot7 = slot0.GetRealId(slot6.id)

		if _.any(slot1, function (slot0)
			return slot0 == slot0
		end) then
			slot0.MarkShipBeRecommanded(slot0, slot6, true)
		end
	end
end
...
slot0.SetShipBeRecommanded = function (slot0, slot1, slot2)
	for slot6, slot7 in ipairs(slot0.ships) do
		if slot1 == slot0.GetRealId(slot7.id) then
...
slot0.GetShipByRealId = function (slot0, slot1, slot2)
	slot3 = slot0.GetVirtualId(slot1, slot2)
...
slot0.InsertBayShip = function (slot0, slot1, slot2)
	slot2.id = slot0.GetVirtualId(slot0.userId, slot2.id)
...
slot0.PositionIsChanged = function (slot0, slot1, slot2)
	...
	slot6 = (slot1.GetShipByPos(slot1, slot2) and slot4.id) or 0

	if slot6 ~= ((slot5 and slot5.id) or 0) or slot3(slot4, slot5) then
		return true
	end
