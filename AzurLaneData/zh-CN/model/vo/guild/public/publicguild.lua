...
slot0.Ctor = function (slot0, slot1)
	...
	for slot5, slot6 in pairs(slot0.get_id_list_by_group) do
		slot0.technologyGroups[slot5] = GuildTechnologyGroup.New({
			id = slot5
		})
	...
	for slot5, slot6 in slot2(slot3) do
		slot0.technologyGroups[slot0[slot6.id].group]:update(slot6)
	end
...
slot0.InitUser = function (slot0, slot1)
	...
	for slot5, slot6 in slot2(slot3) do
		slot0.technologys[slot0[slot6].group]:Update(slot6, slot0.technologyGroups[slot0[slot6].group])
	end
end
