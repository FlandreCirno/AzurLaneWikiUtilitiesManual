...
slot0.Ctor = function (slot0, slot1)
	...
	slot0:update({
		...
		fake_id = slot0.bindConfigTable().get_id_list_by_group[slot0.id][1]
	})
end
...
slot0.isStarting = function (slot0)
	return slot0.state == slot0.STATE_START
end

slot0.GetDesc = function (slot0)
	slot3 = slot0:bindConfigTable()[slot0.pid].effect_args

	if slot0.bindConfigTable()[slot0.pid].next_tech == 0 then
...
slot0.Stop = function (slot0)
	slot0.state = slot0.STATE_STOP
end

slot0.Start = function (slot0)
	slot0.state = slot0.STATE_START
end
