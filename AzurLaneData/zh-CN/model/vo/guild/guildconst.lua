...
slot0.GET_TECHNOLOGY_GROUP_DESC = function (slot0, slot1, slot2)
	...
	elseif slot3 == GuildConst.TYPE_GUILD_MEMBER_CNT then
		...
		slot6 = _.map(slot5, function (slot0)
			return pg.ship_data_by_type[slot0].type_name
		end)

		return i18n("guild_ship_attr_desc", table.concat(slot6, ","), AttributeType.Type2Name(slot3), slot4)
	end
end
...
slot0.GET_TECHNOLOGY_DESC = function (slot0, slot1)
	...
	elseif slot2 == GuildConst.TYPE_GUILD_MEMBER_CNT then
		...
		return i18n("guild_ship_attr_desc", table.concat(slot4, ","), AttributeType.Type2Name(slot2), slot1)
	end
end
