...
slot0.Ctor = function (slot0, slot1)
	...
	slot0.state = slot0.STATE_UNSELECT
...
slot0.isUr = function (slot0, slot1)
	for slot5, slot6 in ipairs(slot0:getConfig("ur_char")) do
		if slot1 == slot6 then
			return true
		end
	end
...
slot0.bulidTargetNums = function (slot0)
	...
	for slot4, slot5 in ipairs(slot0:getConfig("char_choice")) do
...
slot0.addTargetNum = function (slot0, slot1, slot2)
	if slot0:isUr(slot1) then
		...
		for slot6, slot7 in ipairs(slot0:getConfig("char_choice")) do
...
slot0.isFinishSSR = function (slot0)
	...
	for slot5, slot6 in ipairs(slot0:getConfig("char_choice")) do
...
slot0.updateState = function (slot0)
	...
	if slot0:isFinishAll() then
		slot0.state = slot0.STATE_FINISHED_ALL
	elseif slot0.targetNums[slot1] then
		slot0.state = slot0.STATE_CATCHUPING
	else
		slot0.state = slot0.STATE_UNSELECT
	end
end
