...
slot0.getCost = function (slot0, slot1)
	...
	_.each(slot4, function (slot0)
		slot0.oil = slot0.oil + slot0:getStartBattleExpend() * slot0
		slot0.oil + slot0.getStartBattleExpend() * slot0.oil = slot0.oil + slot0.getStartBattleExpend() * slot0.oil + slot0:getEndBattleExpend() * (slot0.oil + slot0.getStartBattleExpend() * slot0)
	end)
...
slot0.getInvestSums = function (slot0, slot1)
	return math.pow(_.reduce(slot0.getShips(slot0, slot1), 0, slot2), 0.6666666666666666)
end

slot0.getDodgeSums = function (slot0)
	return math.pow(_.reduce(slot0.getShips(slot0, false), 0, slot1), 0.6666666666666666)
end

slot0.getAntiAircraftSums = function (slot0)
	return _.reduce(slot0.getShips(slot0, false), 0, function (slot0, slot1)
...
slot0.getOwnStrategies = function (slot0)
	...
	if slot0.triggerSkill(slot0, FleetSkill.TypeStrategy) then
...
slot0.canUseStrategy = function (slot0, slot1)
	...
	elseif slot2.type == ChapterConst.StgTypeConsume then
		...
		if slot2.id == ChapterConst.StrategyRepair and _.all(slot0:getShips(true), function (slot0)
			...
			pg.TipsMgr.GetInstance().ShowTips(slot3, i18n("level_scene_full_hp"))
...
slot0.StaticTransformChapterFleet2Fleet = function (slot0, slot1)
	table.insertto(slot2, _.pluck(slot0:getShipsByTeam(TeamType.Main, slot1), "id"))
