...
slot0.GetSkillGroup = function (slot0)
	...
	while slot2 and slot2 ~= 0 do
		table.insert(slot1, pg.commander_skill_template[slot2])

		slot2 = pg.commander_skill_template[slot2].prev_id
	end
	...
	while slot3 and slot3 ~= 0 do
		table.insert(slot1, pg.commander_skill_template[slot3])

		slot3 = pg.commander_skill_template[slot3].next_id
	end
