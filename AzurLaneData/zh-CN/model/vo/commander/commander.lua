...
slot0.getConfigExp = function (slot0, slot1)
	return slot0[math.max(slot1, 1)]["exp_" .. slot0:getRarity()] or slot2.exp
end
...
slot0.canEquipToEliteChapter = function (slot0, slot1, slot2, slot3)
	return slot0.canEquipToFleetList(getProxy(ChapterProxy).getChapterById(slot4, slot0):getEliteFleetCommanders() or {}, slot1, slot2, slot3)
end
