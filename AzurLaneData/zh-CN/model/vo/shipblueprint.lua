...
slot0.getFateMaxLeftOver = function (slot0)
	return (((ShipRarity.SSR <= slot0:getShipVO():getRarity() and pg.gameset.fate_sim_ur.key_value) or pg.gameset.fate_sim_ssr.key_value) - slot0:getFateUseNum() < 0 and ((ShipRarity.SSR <= slot0.getShipVO().getRarity() and pg.gameset.fate_sim_ur.key_value) or pg.gameset.fate_sim_ssr.key_value)) or slot2
end
