...
slot0.GetEquipmentTransformCandicates = function (slot0, slot1)
	slot3 = _.map(slot0:GetSameTypeInEquips(slot1), function (slot0)
		return {
...
slot0.GetEquipTraceBack = function (slot0, slot1, slot2, slot3)
	...
	for slot9, slot10 in ipairs(slot5) do
		table.insert((slot9 == #slot5 and slot2) or Clone(slot2), pg.equip_upgrade_data[slot10].upgrade_from)

		(slot9 == #slot5 and slot2) or Clone(slot2).formulas = (slot9 == #slot5 and slot2) or Clone(slot2).formulas or {}

		table.insert((slot9 == #slot5 and slot2) or Clone(slot2).formulas, 1, slot10)
...
slot0.GetSortedEquipTraceBack = function (slot0, ...)
	table.sort(slot0:GetEquipTraceBack(...), function (slot0, slot1)
		if #slot0 ~= #slot1 then
			return #slot0 < #slot1
		else
	...
	return slot0.GetEquipTraceBack(...)
end
