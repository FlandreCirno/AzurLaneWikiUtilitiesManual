...
slot0.Create = function (slot0, slot1)
	...
	return (slot1 ~= slot0.TYPE_CHARGE or ChargeCommodity.New(slot0, slot1)) and ((slot1 ~= slot0.TYPE_ACTIVITY and slot1 ~= slot0.TYPE_SHAM_BATTLE and slot1 ~= slot0.TYPE_FRAGMENT and slot1 ~= slot0.TYPE_FRAGMENT_NORMAL and slot1 ~= slot0.TYPE_ESCORT) or ActivityCommodity.New(slot0, slot1)) and (slot1 ~= slot0.TYPE_ACTIVITY_EXTRA or ActivityExtraCommodity.New(slot0, slot1)) and CommonCommodity.New(slot0, slot1)
end
