...
slot0.comforChatContent = function (slot0)
	...
	return i18n("backyard_backyardScene_comforChatContent2", slot0.comforChatState[slot0.getComBGIndex(slot0)], string.format("%d", slot3), slot0.level - 1) .. i18n("backyard_backyardScene_comforChatContent1", unpack(_.map(slot4, function (slot0)
		return slot0[2]
	end)))
end
...
slot0.IsMaxLevel = function (slot0)
	return slot0.MAX_LEVEL <= slot0.level
end

slot0.GetMapSize = function (slot0)
	return 12 - (slot0.level - 1) * 4, , BackYardHouseVO.MAX_SIZE_X, BackYardHouseVO.MAX_SIZE_Y
end

slot0.GetPutCntForFurniture = function (slot0, slot1)
	slot3 = 0
...
slot0.getComfortable = function (slot0, slot1)
	...
	for slot8, slot9 in pairs(slot4) do
		...
		end).sort(slot11, function (slot0, slot1)
			return slot1:getConfig("comfortable") < slot0:getConfig("comfortable")
		end).slice(slot11, 1, slot9[2]):value(), 0, function (slot0, slot1)
	...
	if slot0.isUnlockFloor(slot0, 2) then
...
slot0.OwnThemeTemplateFurniture = function (slot0, slot1)
	slot2 = slot0:GetAllFurniture()

	function slot3(slot0, slot1)
		return slot0[slot0] and slot1 <= slot2.count
	end
...
slot0.ClearPositionByFloor = function (slot0, slot1)
	for slot5, slot6 in pairs(slot0.furnitures) do
...
slot0.SetPostionForFloor = function (slot0, slot1, slot2)
