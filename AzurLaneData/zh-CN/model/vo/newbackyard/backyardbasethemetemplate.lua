...
slot0.ExistLocalImage = function (slot0)
	function slot1()
		slot0 = BackYardBaseThemeTemplate.BuildId(slot0.pos)

		return BackYardThemeTempalteUtil.GetMd5(slot0) == slot0.imageMd5 and BackYardThemeTempalteUtil.GetIconMd5(slot0) == slot0.iconImageMd5
	end

	return BackYardThemeTempalteUtil.FileExists(slot0.id) and slot1()
end
...
slot0.ContainsFurniture = function (slot0, slot1)
...
slot0.MatchSearchKey = function (slot0, slot1)
	...
	return not function (slot0)
		return string.find(string.lower(slot0:GetName()), slot0)
	end(function (slot0)
		return string.find(string.lower(slot0:GetDesc()), slot0)
	end) or slot1 == "" or slot2(slot1) or function (slot0)
		return string.find(string.lower(slot0.GetDesc()), slot0)
	end(slot1)
end
