...
slot0.NeedMarkAsLurk = function (slot0)
	if slot0.attachment == slot0.AttachBox then
		return slot0.flag == ChapterConst.CellFlagActive and (pg.box_data_template[slot0.attachmentId].type == slot0.BoxDrop or pg.box_data_template[slot0.attachmentId].type == slot0.BoxStrategy or pg.box_data_template[slot0.attachmentId].type == slot0.BoxSupply or pg.box_data_template[slot0.attachmentId].type == slot0.BoxEnemy)
	else
		return slot0.flag == ChapterConst.CellFlagActive and (slot0.attachment == slot0.AttachEnemy or slot0.attachment == slot0.AttachElite or slot0.attachment == slot0.AttachBoss or slot0.attachment == slot0.AttachStory or slot0.attachment == slot0.AttachBomb_Enemy)
	end
end
...
slot0.NeedEasePathCell = function (slot0)
	...
	elseif slot0.attachment == slot0.AttachEnemy or slot0.attachment == slot0.AttachElite then
	...
	elseif slot0.attachment == slot0.AttachBox then
		if pg.box_data_template[slot0.attachmentId].type == slot0.BoxAirStrike or slot1.type == slot0.BoxTorpedo then
			return true
		elseif (slot1.type == slot0.BoxDrop or slot1.type == slot0.BoxStrategy or slot1.type == slot0.BoxEnemy or slot1.type == slot0.BoxSupply) and slot0.flag == ChapterConst.CellFlagDisabled then
			return true
		end
	elseif slot0.attachment == slot0.AttachStory then
		if slot0.flag ~= ChapterConst.CellFlagActive and (slot0.flag ~= ChapterConst.CellFlagTriggerActive or slot0.data ~= slot0.StoryObstacle) then
			return true
		end
...
slot0.NeedClearStep = function (slot0)
	if slot0.attachment == slot0.AttachAmbush and slot0.flag == ChapterConst.CellFlagAmbush then
		return true
	end
