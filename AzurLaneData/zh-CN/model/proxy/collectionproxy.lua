...
slot0.register = function (slot0)
	...
	slot0.on(slot0, 17002, function (slot0)
		for slot4, slot5 in ipairs(slot0.progress_list) do
			slot6 = false
	...
	slot0.on(slot0, 17004, function (slot0)
...
slot0.getCollectionCount = function (slot0)
	return _.reduce(_.values(slot0.shipGroups), 0, function (slot0, slot1)
		return slot0 + ((not Nation.IsLinkType(slot1:getNation()) or 0) and ((slot1.trans and 2) or 1))
	end)
end

slot0.getCollectionTotal = function (slot0)
	return _.reduce(pg.ship_data_group.all, 0, function (slot0, slot1)
		return slot0 + ((not Nation.IsLinkType(ShipGroup.getDefaultShipConfig(slot2).nationality) or 0) and 1)
