...
slot0.register = function (slot0)
	...
	slot0:on(25001, function (slot0)
		...
		if not LOCK_CATTERY then
			slot0.sendNotification(slot1, GAME.GET_COMMANDER_HOME)
		end
	end)
end
...
slot0.StartCalcExpTimer = function (slot0, slot1)
	...
	slot0.calcExpTimer = Timer.New(function ()
		slot0:RemoveCalcExpTimer()
		slot0.RemoveCalcExpTimer.sendNotification(slot1, GAME.CALC_CATTERY_EXP, {
			isPeriod = slot0.RemoveCalcExpTimer.sendNotification.RemoveCalcExpTimer == 3600
		})
		slot0.RemoveCalcExpTimer.sendNotification:StartCalcExpTimer(3600)
	end, slot1, 1)
