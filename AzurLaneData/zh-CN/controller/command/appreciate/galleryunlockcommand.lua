class("GalleryUnlockCommand", pm.SimpleCommand).execute = function (slot0, slot1)
	...
	pg.ConnectionMgr.GetInstance():Send(17501, {
		...
		if slot0.result == 0 then
			slot0:addPicIDToUnlockList(slot0.addPicIDToUnlockList)
...
return class("GalleryUnlockCommand", pm.SimpleCommand)
