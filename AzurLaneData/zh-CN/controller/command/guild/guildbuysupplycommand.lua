class("GuildBuySupplyCommand", pm.SimpleCommand).execute = function (slot0, slot1)
	slot2 = slot1:getBody()
	...
	pg.ConnectionMgr.GetInstance():Send(62007, {
		...
		if slot0.result == 0 then
			slot0:sendNotification(GAME.GUILD_BUY_SUPPLY_DONE)
		else
...
return class("GuildBuySupplyCommand", pm.SimpleCommand)
