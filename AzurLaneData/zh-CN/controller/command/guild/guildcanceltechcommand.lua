class("GuildCancelTechCommand", pm.SimpleCommand).execute = function (slot0, slot1)
	...
	pg.ConnectionMgr.GetInstance():Send(62026, {
		...
		if slot0.result == 0 then
			slot0:sendNotification(GAME.GUILD_CANCEL_TECH_DONE)
		else
...
return class("GuildCancelTechCommand", pm.SimpleCommand)
