class("GuildFetchCapitalLogCommand", pm.SimpleCommand).execute = function (slot0, slot1)
	slot2 = slot1:getBody()
	...
	pg.ConnectionMgr.GetInstance():Send(62011, {
		...
		if slot0.result == 0 then
			...
			slot1:sendNotification(GAME.GUILD_FETCH_CAPITAL_LOG_DONE)
		else
...
return class("GuildFetchCapitalLogCommand", pm.SimpleCommand)
