class("GuildStartTechGroupCommand", pm.SimpleCommand).execute = function (slot0, slot1)
	...
	pg.ConnectionMgr.GetInstance():Send(62020, {
		...
		if slot0.result == 0 then
			slot0:sendNotification(GAME.GUILD_START_TECH_TASK_DONE)
		else
...
return class("GuildStartTechGroupCommand", pm.SimpleCommand)
