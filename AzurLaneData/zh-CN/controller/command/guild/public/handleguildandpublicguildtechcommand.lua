class("HandleGuildAndPublicGuildTechCommand", pm.SimpleCommand).execute = function (slot0, slot1)
...
return class("HandleGuildAndPublicGuildTechCommand", pm.SimpleCommand)
