class("WorldBossPtRecoverCommand", pm.SimpleCommand).execute = function (slot0, slot1)
	if nowWorld.GetBossProxy(slot2):isMaxPt() then
		return
	end
...
return class("WorldBossPtRecoverCommand", pm.SimpleCommand)
