...
slot0.execute = function (slot0, slot1)
	if getProxy(EventProxy).findInfoById(slot4, slot3):IsActivityType() then
...
slot0.OnCancel = function (slot0)
	...
	slot2, slot3 = getProxy(EventProxy).findInfoById(slot1, slot0)
