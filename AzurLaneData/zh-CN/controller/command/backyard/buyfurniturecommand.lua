	...
	function slot9()
		pg.ConnectionMgr.GetInstance():Send(19006, {
			...
			if slot0.result == 0 then
				...
				if pg.furniture_data_template[slot4[1]] and slot2.themeId > 0 then
					slot5:ResetSystemTheme(slot2.themeId)
				end

				slot5:AddFurnitrues(slot5)
				slot6:sendNotification(GAME.BUY_FURNITURE_DONE, slot5:getData(), slot6)
