class("MetaCharacterTacticsInfoRequestCommand", pm.SimpleCommand).execute = function (slot0, slot1)
	slot4 = ""
...
return class("MetaCharacterTacticsInfoRequestCommand", pm.SimpleCommand)
