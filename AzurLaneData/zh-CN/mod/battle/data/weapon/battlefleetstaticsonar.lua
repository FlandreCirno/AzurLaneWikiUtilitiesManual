...
slot9 = ys.Battle.BattleConfig.VAN_SONAR_PROPERTY
slot10 = class("BattleFleetStaticSonar")
ys.Battle.BattleFleetStaticSonar = slot10
...
slot10.calcSonarRange = function (slot0)
	...
	return slot1, Mathf.Clamp(slot3 / slot0.MAIN_SONAR_PROPERTY.a, slot0.MAIN_SONAR_PROPERTY.minRange, slot0.MAIN_SONAR_PROPERTY.maxRange), slot2
end
...
slot10.updateSonarState = function (slot0)
	...
	slot0._fleetVO:DispatchEvent(slot1.Event.New(slot1.Battle.BattleEvent.SONAR_UPDATE))
end

slot10.getSonarProperty = function (slot0)
	slot3 = 0

	if slot0[slot0:GetTemplate().type] then
...
slot10.GetTotalRangeDetail = function (slot0)
	slot4, slot5, slot6 = slot0:calcSonarRange()
