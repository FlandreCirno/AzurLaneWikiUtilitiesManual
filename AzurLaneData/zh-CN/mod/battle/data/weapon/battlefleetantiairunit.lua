...
slot8.AddPreCastTimer = function (slot0)
	...
	slot0._precastTimer = pg.TimeMgr.GetInstance().AddBattleTimer(slot2, "", 0, slot1.AntiAirConfig.Precast_duration, function ()
		slot0:RemovePrecastTimer()
...
slot8.Fire = function (slot0)
	...
	slot0._dataProxy.SpawnColumnArea(slot2, slot1.AOEField.AIR, slot0._host:GetIFF(), slot0._host:GetPosition(), slot0._range * 2, -1, function (slot0)
		slot1 = {}
