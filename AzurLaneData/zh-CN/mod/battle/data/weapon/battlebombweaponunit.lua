...
slot2.HostOnEnemy = function (slot0)
	...
	if slot0._preCastInfo.alertTime ~= nil then
		...
		slot0._alertTimer = pg.TimeMgr.GetInstance().AddBattleTimer(slot2, "", -1, slot0._preCastInfo.alertTime or 3, function ()
...
slot2.createMajorEmitter = function (slot0, slot1, slot2, slot3, slot4, slot5)
	...
	function slot8()
		slot0:DispatchBulletEvent(table.remove(slot0, 1))
	end
