...
ys.Battle.BattleAllInStrike.ReloadBoost = function (slot0, slot1)
	table.insert(slot0._reloadBoostList, slot1)
end

ys.Battle.BattleAllInStrike.AppendReloadBoost = function (slot0, slot1)
	if slot0._currentState == slot0.STATE_OVER_HEAT then
...
ys.Battle.BattleAllInStrike.CLSBullet = function (slot0)
	slot0.Battle.BattleDataProxy.GetInstance():CLSBullet(slot0._host:GetIFF() * -1, true)
end
...
ys.Battle.BattleAllInStrike.GetReloadRate = function (slot0)
...
ys.Battle.BattleAllInStrike.GetDamageSUM = function (slot0)
	slot1 = 0
	slot2 = 0
...
ys.Battle.BattleAllInStrike.GetStrikeSkillID = function (slot0)
