...
slot4.createMajorEmitter = function (slot0, slot1, slot2)
	slot1.super.createMajorEmitter(slot0, slot1, slot2, slot1.EMITTER_NORMAL, function (slot0, slot1, slot2, slot3)
		slot4, slot5 = nil
		slot6 = slot0._emitBulletIDList[slot1]
...
slot4.SpawnPointBullet = function (slot0, slot1, slot2)
	slot0:TriggerBuffWhenSpawn(bulletUnit, slot0.BuffEffectType.ON_MANUAL_BULLET_CREATE)

	slot3 = slot0._dataProxy:CreateBulletUnit(slot1, slot0._host, slot0, slot2)

	slot0:setBulletSkin(slot3, slot1)
	slot3:SetDamageEnhance(slot1.Battle.BattleConfig.ChargeWeaponConfig.Enhance + slot0._host:GetAttrByName("initialEnhancement") + slot0._host:GetAttrByName("manualEnhancement"))
	slot0:TriggerBuffWhenSpawn(slot3)
	slot0:TriggerBuffWhenSpawn(slot3, slot0.BuffEffectType.ON_INTERNAL_BULLET_CREATE)
