...
ys.Battle.BattleDataProxy.CalcMaxRestHPRateBossRate = function (slot0, slot1)
...
ys.Battle.BattleDataProxy.CalcActBossDamageInfo = function (slot0, slot1)
	slot0:CalcSpecificEnemyInfo(slot0.GetSpecificEnemyList(slot1, slot0._expeditionID))
end

ys.Battle.BattleDataProxy.CalcWorldBossDamageInfo = function (slot0, slot1, slot2, slot3)
	slot0:CalcSpecificEnemyInfo(slot0.GetSpecificWorldJointEnemyList(slot1, slot2, slot3))
end

ys.Battle.BattleDataProxy.CalcGuildBossEnemyInfo = function (slot0, slot1)
	slot0:CalcSpecificEnemyInfo(slot0.GetSpecificGuildBossEnemyList(slot1, slot0._expeditionID))
end
...
ys.Battle.BattleDataProxy.CalcSubRountineTimeUp = function (slot0)
	slot0._statistics._badTime = true
...
ys.Battle.BattleDataProxy.CalcSubRountineElimate = function (slot0)
...
ys.Battle.BattleDataProxy.CalcSubRoutineScore = function (slot0)
	if ((((not slot0._statistics._badTime and not slot0._statistics._elimated) or 0) and slot0.SR_CONFIG.BASE_POINT) + slot0._subRunStatistics.score * slot0.SR_CONFIG.POINT) - slot0._statistics._deadCount * slot0.SR_CONFIG.DEAD_POINT >= slot0.SR_CONFIG.BASE_POINT + slot0.SR_CONFIG.M * slot0.SR_CONFIG.POINT then
		slot0._statistics._battleScore = slot1.BattleScore.S
...
ys.Battle.BattleDataProxy.AirFightInit = function (slot0)
...
ys.Battle.BattleDataProxy.AddAirFightScore = function (slot0, slot1)
...
ys.Battle.BattleDataProxy.DecreaseAirFightScore = function (slot0, slot1)
...
ys.Battle.BattleDataProxy.CalcAirFightScore = function (slot0)
	slot0._statistics._battleScore = slot0.BattleScore.S
end
