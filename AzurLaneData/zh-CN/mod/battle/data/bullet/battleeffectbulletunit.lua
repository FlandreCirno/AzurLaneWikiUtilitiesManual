...
slot1.spawnArea = function (slot0, slot1)
	...
	slot8 = slot0._battleProxy.SpawnLastingColumnArea(slot8, slot0:GetEffectField(), slot0:GetIFF(), pg.Tool.FilterY(slot0:GetPosition():Clone()), slot0.GetTemplate().hit_type.range, time, function (slot0)
