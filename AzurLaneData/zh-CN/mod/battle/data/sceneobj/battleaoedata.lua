...
slot2.UpdateDistanceInfo = function (slot0)
	for slot4, slot5 in ipairs(slot0._cldObjList) do
		...
		slot0._cldObjDistanceList[slot5.UID] = (not slot12 or not slot15 or 0) and (not slot12 or math.abs(slot16 - slot14)) and (not slot15 or math.abs(slot13 - slot11)) and math.sqrt((slot13 - slot11)^2 + (slot16 - slot14)^2)
	end
end
