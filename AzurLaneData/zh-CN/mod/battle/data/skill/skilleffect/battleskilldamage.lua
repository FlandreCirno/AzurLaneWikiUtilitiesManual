...
ys.Battle.BattleSkillDamage.DoDataEffect = function (slot0, slot1, slot2)
	...
	slot2:UpdateHP(-(math.floor(slot5 * slot0._rate) + slot0._number), slot3)
	slot0.Battle.BattleDataProxy.GetInstance().DamageStatistics(slot7, slot1:GetAttrByName("id"), slot2:GetAttrByName("id"), math.floor(slot5 * slot0._rate) + slot0._number)
