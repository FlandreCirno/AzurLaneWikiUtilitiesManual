ys = ys or {}
slot1 = class("BattleSkillCLS", ys.Battle.BattleSkillEffect)
ys.Battle.BattleSkillCLS = slot1
...
slot1.doCls = function (slot0, slot1)
	...
	for slot7, slot8 in ipairs(slot0._clsTypeList) do
		if slot8 == slot1.TYPE_BULLET then
			slot2:CLSBullet(slot3)
		elseif slot8 == slot1.TYPE_AIRCRAFT then
			slot2:CLSAircraft(slot3)
		elseif slot8 == slot1.TYPE_MINION then
			slot2:CLSMinion()
		end
	end
end
