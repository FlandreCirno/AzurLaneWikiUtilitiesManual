...
ys.Battle.BattleFleetBuffBlindAura.Ctor = function (slot0, slot1)
	slot0.super.Ctor(slot0, slot1)
end

ys.Battle.BattleFleetBuffBlindAura.SetArgs = function (slot0, slot1, slot2)
	slot3 = slot0._tempData.arg_list.target
	slot0._aura = slot0.Battle.BattleDataProxy.GetInstance().SpawnLastingCubeArea(slot7, slot1.AOEField.SURFACE, slot1:GetIFF(), Vector3(-55, 0, 55), 180, 70, 0, function (slot0)
...
ys.Battle.BattleFleetBuffBlindAura.Clear = function (slot0)
