...
slot3 = class("BattleBuffNewWeapon", ys.Battle.BattleBuffEffect)
ys.Battle.BattleBuffNewWeapon = slot3
...
slot3.onAttach = function (slot0, slot1, slot2)
	...
	elseif slot0.GetWeaponPropertyDataFromID(slot0._weaponID).type == slot1.EquipmentType.FLEET_ANTI_AIR then
...
slot3.onRemove = function (slot0, slot1, slot2)
	...
	elseif slot0._weapon then
		if slot0.GetWeaponPropertyDataFromID(slot0._weaponID).type == slot1.EquipmentType.FLEET_ANTI_AIR then
