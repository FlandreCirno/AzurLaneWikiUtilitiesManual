ys = ys or {}
slot1 = class("BattleBuffField", ys.Battle.BattleBuffEffect)
ys.Battle.BattleBuffField = slot1
...
slot1.SetArgs = function (slot0, slot1, slot2)
	...
	slot0._aura = slot0.Battle.BattleDataProxy.GetInstance().SpawnLastingCubeArea(slot9, slot1.AOEField.SURFACE, slot1:GetIFF(), Vector3(-55, 0, 55), 180, 70, 0, function (slot0)
