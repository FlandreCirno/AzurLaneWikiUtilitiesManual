...
ys.Battle.BattlePlayerUnit.SetTemplate = function (slot0, slot1, slot2, slot3)
		...
		elseif slot9 <= Ship.WEAPON_COUNT then
			...
			function slot13(slot0, slot1, slot2)
				for slot7 = 1, slot0[slot1], 1 do
					...
					if slot6.equipment then
						slot8:SetSrcEquipmentID(slot6.equipment.id)
					end
				end
			end

			if slot10.equipment then
				slot14 = slot10.equipment.weapon_id
...
ys.Battle.BattlePlayerUnit.AddWeapon = function (slot0, slot1, slot2, slot3, slot4, slot5)
	...
	elseif slot7 == slot1.MANUAL_TORPEDO or slot7 == slot1.DISPOSABLE_TORPEDO or slot7 == slot1.MANUAL_AAMISSILE then
...
ys.Battle.BattlePlayerUnit.AddFleetAntiAirWeapon = function (slot0, slot1)
	slot0._fleetAAList[#slot0._fleetAAList + 1] = slot1
end

ys.Battle.BattlePlayerUnit.RemoveFleetAntiAirWeapon = function (slot0, slot1)
...
ys.Battle.BattlePlayerUnit.CeaseAllWeapon = function (slot0, slot1)
	if slot1 then
	...
	slot0.super.CeaseAllWeapon(slot0, slot1)
end
...
ys.Battle.BattlePlayerUnit.setAttrFromOutBattle = function (slot0, slot1, slot2)
	slot0:SetPlayerAttrFromOutBattle(slot1, slot2)
end
