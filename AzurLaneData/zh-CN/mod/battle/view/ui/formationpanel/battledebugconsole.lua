...
ys.Battle.BattleDebugConsole.initDebug = function (slot0)
	...
	slot0._summon = slot0._debug.Find(slot1, "summon_enemy")
	...
	slot0._killAllEnemy = slot0._debug.Find(slot1, "clear_enemy")

	onButton(nil, slot0._killAllEnemy, function ()
		slot0._dataProxy:KillAllEnemy()
	end, SFX_PANEL)

	slot0._summonStrike = slot0._debug.Find(slot1, "spawn_strike")
	...
	slot0._killAllStrike = slot0._debug.Find(slot1, "clear_strike")

	onButton(nil, slot0._killAllStrike, function ()
		slot0._dataProxy:KillAllAirStrike()
	end, SFX_PANEL)

	slot0._blockCld = slot0._debug.Find(slot1, "all_cld")
	...
	slot0._setDungeonLevel = slot0._debug.Find(slot1, "dungeon_level")
	...
	slot0._clsBullet = slot0._debug.Find(slot1, "cls_bullet")
...
ys.Battle.BattleDebugConsole.initComponent = function (slot0)
	...
	slot0._activeReference = slot0._common.Find(slot1, "reference_switch")

	onButton(nil, slot0._activeReference, function ()
		slot0:activeReference()
	end, SFX_PANEL)

	slot0._lockCommonDMG = slot0._common.Find(slot1, "common_damage")
	...
	slot0._triggerWave = slot0._common.Find(slot1, "wave_trigger")
	...
	slot0._antiSubDetailRange = slot0._common.Find(slot1, "anti_sub_detail")

	onButton(nil, slot0._antiSubDetailRange, function ()
		slot0._state:GetMediatorByName("BattleSceneMediator"):InitDetailAntiSubArea()
	end)

	slot0._instantReload = slot0._common.Find(slot1, "instant_reload")

	onButton(nil, slot0._instantReload, function ()
		slot1(slot0._dataProxy._fleetList[1].GetChargeWeaponVO(slot0))
		slot1(slot0._dataProxy._fleetList[1].GetTorpedoWeaponVO(slot0))
		function (slot0)
			for slot5, slot6 in ipairs(slot1) do
				slot6:QuickCoolDown()
			end
		end(slot0._dataProxy._fleetList[1]:GetAirAssistVO())
	end)

	slot0._white = slot0._base.Find(slot1, "white_button")
...
ys.Battle.BattleDebugConsole.activeReference = function (slot0)
	...
	slot1 = slot0._state:GetMediatorByName(slot0.Battle.BattleReferenceBoxMediator.__name) or slot0._state:AddMediator(slot0.Battle.BattleReferenceBoxMediator.New())
	...
	slot0._shipBox = slot0._referenceConsole.Find(slot2, "ship_box")
