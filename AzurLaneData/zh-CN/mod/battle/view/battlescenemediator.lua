...
slot5.InitDetailAntiSubArea = function (slot0)
	...
	function (slot0, slot1, slot2)
		slot3 = slot0._fxPool:GetFX("AntiSubArea")
		slot3.name = slot2
		slot3.transform.localScale = Vector3(slot0, 0, slot0)
		slot3.transform.Find(slot4, "static"):GetComponent("SpriteRenderer").color = slot1

		slot3:SetActive(true)

		slot0._anitSubAreaTFList[slot3.transform] = true
	end(slot1, Color.New(1, 0, 0, 1), "基础直径：" .. slot1)
end
...
slot5.AddEvent = function (slot0)
	...
	slot0._dataProxy:RegisterEventListener(slot0, slot0.ADD_EFFECT, slot0.onAddEffect)
	...
	slot0._dataProxy:RegisterEventListener(slot0, slot0.ADD_CAMERA_FX, slot0.onAddCameraFX)
end

slot5.RemoveEvent = function (slot0)
	slot0._leftFleet:UnregisterEventListener(slot0, slot0.SONAR_SCAN)
	slot0._leftFleet:UnregisterEventListener(slot0, slot0.SONAR_UPDATE)
	...
	slot0._dataProxy:UnregisterEventListener(slot0, slot0.ADD_EFFECT)
	...
	slot0._dataProxy:UnregisterEventListener(slot0, slot0.ADD_CAMERA_FX)
...
slot5.onStageInitFinish = function (slot0, slot1)
	...
	slot0._leftFleet:RegisterEventListener(slot0, slot1.SONAR_UPDATE, slot0.onUpdateHostileSubmarine)
end
...
slot5.updateSonarView = function (slot0)
	...
	slot0._anitSubArea.gameObject:SetActive(slot0._leftFleet:GetFleetSonar():GetCurrentState() ~= slot0.Battle.BattleFleetStaticSonar.STATE_DISABLE and slot1)

	if slot0._leftFleet.GetFleetSonar().GetCurrentState() ~= slot0.Battle.BattleFleetStaticSonar.STATE_DISABLE and slot1 then
		slot0._anitSubAreaTF.localScale = Vector3(slot0._leftFleet:GetFleetSonar():GetRange(), 0, )
	end
end
...
slot5.onSonarScan = function (slot0, slot1)
	...
	if slot0._antiSubScanAnima and slot0._sonarActive then
		...
		slot0._antiSubScanAnima.Play(slot3, "antiSubZoom", -1, 0)
	end
end
...
slot5.onAddCameraFX = function (slot0, slot1)
	slot0:AddCameraFX(slot1.Data.orderDiff, slot1.Data.FXID, slot1.Data.position, slot1.Data.localScale)
end

slot5.AddCameraFX = function (slot0, slot1, slot2, slot3, slot4)
	slot6 = slot0._cameraUtil:Add2Camera(slot0._fxPool:GetFX(slot2), slot1)
	slot5.transform.localScale = Vector3((slot4 or 1) / slot6.x, (slot4 or 1) / slot6.y, (slot4 or 1) / slot6.z)
...
slot5.Pause = function (slot0)
	...
	for slot4, slot5 in pairs(slot0._particleBulletList) do
		for slot10 = 0, slot4._go:GetComponentsInChildren(typeof(ParticleSystem)).Length - 1, 1 do
			slot6[slot10]:Pause()
		end
	end
end
...
slot5.PauseCharacterAction = function (slot0, slot1)
	for slot5, slot6 in pairs(slot0._characterList) do
...
slot5.AddArea = function (slot0, slot1, slot2)
...
slot5.AddEffect = function (slot0, slot1, slot2, slot3)
	slot0._fxPool:GetFX(slot1).transform.localScale = Vector3(slot3 or 1, 1, )

	pg.EffectMgr.GetInstance():PlayBattleEffect(slot0._fxPool.GetFX(slot1), slot2, true)
end

slot5.AddArcEffect = function (slot0, slot1, slot2, slot3, slot4)
	slot0.Battle.BattleArcEffect.New(slot5, slot2, slot3, slot4).ConfigCallback(slot6, slot7)
	table.insert(slot0._arcEffectList, slot0.Battle.BattleArcEffect.New(slot5, slot2, slot3, slot4))
end

slot5.RemoveArcEffect = function (slot0, slot1)
