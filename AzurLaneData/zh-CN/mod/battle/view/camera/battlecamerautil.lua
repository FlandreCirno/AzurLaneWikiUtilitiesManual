...
slot4.DoShake = function (slot0)
	...
	if slot0._shakeInfo._duration < slot0._shakeInfo._elapsed then
		if slot0._shakeInfo._bounce then
			slot0.bounceReverse(slot0._shakeInfo)
...
slot4.ZoomCamara = function (slot0, slot1, slot2, slot3, slot4)
	...
	if slot4 then
		slot5.setEase(slot5, LeanTweenType.easeOutExpo)
	end
end
...
slot4.FocusCharacter = function (slot0, slot1, slot2, slot3, slot4, slot5)
	...
	if slot1 ~= nil then
		...
		slot0._fromTo.SetFromTo(slot10, slot0._camera, slot7, slot8, slot2, delay, slot5, slot9)
		slot0:SwitchCameraPos(slot0.TWEEN_TO_CHARACTER)
	end
...
slot4.ResetFocus = function (slot0)
	...
	slot0.DispatchEvent(slot0, slot2.Event.New(slot3.CAMERA_FOCUS_RESET, {}))
end
...
slot4.Add2Camera = function (slot0, slot1, slot2)
	tf(slot1).SetParent(slot1, slot0._cameraTF)
	pg.ViewUtils.SetSortingOrder(tf(slot1), slot2 or 0)
