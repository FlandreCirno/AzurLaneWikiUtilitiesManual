...
ys.Battle.BattleBulletFactory.GetFactoryList = function ()
	if slot0._factoryList == nil then
		slot0._factoryList = {
			...
			[slot1.BulletType.ELECTRIC_ARC] = slot2.Battle.BattleElectricArcBulletFactory.GetInstance(),
			[slot1.BulletType.SPACE_LASER] = slot2.Battle.BattleSpaceLaserFactory.GetInstance(),
			[slot1.BulletType.MISSILE] = slot2.Battle.BattleMissileFactory.GetInstance(),
			[slot1.BulletType.SCALE] = slot2.Battle.BattleScaleBulletFactory.GetInstance(),
			[slot1.BulletType.TRIGGER_BOMB] = slot2.Battle.BattleTriggerBulletFactory.GetInstance(),
			[slot1.BulletType.AAMissile] = slot2.Battle.BattleAAMissileFactory.GetInstance()
		}
	end
