...
ys.Battle.BattleEffectBulletFactory.Ctor = function (slot0)
	slot0.super.Ctor(slot0)
end

ys.Battle.BattleEffectBulletFactory.MakeBullet = function (slot0)
	return slot0.Battle.BattleTorpedoBullet.New()
end

ys.Battle.BattleEffectBulletFactory.onBulletHitFunc = function (slot0, slot1, slot2)
...
ys.Battle.BattleEffectBulletFactory.onBulletMissFunc = function (slot0)
	slot0:onBulletHitFunc()
end

ys.Battle.BattleEffectBulletFactory.MakeModel = function (slot0, slot1, slot2)
