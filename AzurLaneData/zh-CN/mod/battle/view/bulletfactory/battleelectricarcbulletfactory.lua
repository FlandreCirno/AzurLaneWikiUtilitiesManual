...
ys.Battle.BattleElectricArcBulletFactory.Ctor = function (slot0)
	slot0.super.Ctor(slot0)
end

ys.Battle.BattleElectricArcBulletFactory.CreateBullet = function (slot0, slot1, slot2, slot3, slot4, slot5)
