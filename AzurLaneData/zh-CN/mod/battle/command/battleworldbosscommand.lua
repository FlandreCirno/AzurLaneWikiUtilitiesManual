...
slot3 = class("BattleWorldBossCommand", ys.Battle.BattleSingleDungeonCommand)
ys.Battle.BattleWorldBossCommand = slot3
...
slot3.initWaveModule = function (slot0)
	...
	slot0._waveUpdater = slot0.Battle.BattleWaveUpdater.New(slot1, function (slot0)
		...
		slot0:CalcStatistic()
		slot0.CalcStatistic:calcDamageData()
		slot0.CalcStatistic.calcDamageData._state:BattleEnd()
...
slot3.onInitBattle = function (slot0)
	...
	slot0._specificEnemyList = slot1.Battle.BattleDataFunction.GetSpecificWorldJointEnemyList(slot1.ActID, slot1.bossConfigId, slot1.bossLevel)
end
