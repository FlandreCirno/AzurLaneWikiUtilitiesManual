...
ys.Battle.BattleControllerWeaponCommand.TryAutoSub = function (slot0)
	if slot0.Battle.BattleState.IsAutoSubActive(slot0:GetState():GetBattleType()) and slot0._dataProxy:GetFleetByIFF(slot0.Battle.BattleConfig.FRIENDLY_CODE)._submarineVO:GetUseable() and slot3:GetCount() > 0 then
...
ys.Battle.BattleControllerWeaponCommand.InitBattleEvent = function (slot0)
	...
	slot0._dataProxy:RegisterEventListener(slot0, slot0.JAMMING, slot0.onJamming)
end
...
ys.Battle.BattleControllerWeaponCommand.onJamming = function (slot0, slot1)
