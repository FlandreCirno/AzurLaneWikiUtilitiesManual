...
slot3 = class("BattleGuildBossCommand", ys.Battle.BattleSingleDungeonCommand)
ys.Battle.BattleGuildBossCommand = slot3
...
slot3.onInitBattle = function (slot0)
	...
	slot0._specificEnemyList = slot1.Battle.BattleDataFunction.GetSpecificGuildBossEnemyList(slot1.ActID, slot1.StageTmpId)
end
