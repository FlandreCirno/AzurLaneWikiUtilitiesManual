...
slot3.DoPrologue = function (slot0)
	...
	slot0._uiMediator.SeaSurfaceShift(slot2, 45, 0, nil, function ()
		...
		slot0 = slot0._uiMediator.OpeningEffect._dataProxy.GetFleetByIFF(slot0, slot1.Battle.BattleConfig.FRIENDLY_CODE)
...
slot3.initWaveModule = function (slot0)
	...
	slot0._waveUpdater = slot0.Battle.BattleWaveUpdater.New(slot1, function (slot0)
		...
		slot0:CalcStatistic()
		slot0.CalcStatistic._state:BattleEnd()
...
slot3.onWillDie = function (slot0, slot1)
	if slot1.Dispatcher.GetDeathReason(slot2) == slot0.Battle.BattleConst.UnitDeathReason.LEAVE then
		if slot2:GetIFF() == slot0.Battle.BattleConfig.FRIENDLY_CODE then
