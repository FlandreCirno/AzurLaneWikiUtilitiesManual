...
slot0.Make = function (slot0, slot1, slot2)
	...
	function slot4(slot0)
		...
		for slot6, slot7 in ipairs(slot1) do
			...
			setActive(slot0.poolMgr:Dequeue((slot2 and BackyardPoolMgr.POOL_NAME.GRID) or BackyardPoolMgr.POOL_NAME.WALL), false)
		end
...
slot0.loadImageFurniture = function (slot0, slot1, slot2, slot3)
...
slot0.loadArchMask = function (slot0, slot1, slot2, slot3)
...
slot0.loadFurnituresMasks = function (slot0, slot1, slot2, slot3)
	slot5 = {}
...
slot0.loadSpineFurnitureModel = function (slot0, slot1, slot2, slot3)
	...
	LoadAndInstantiateAsync("sfurniture", slot4, function (slot0)
		...
		if slot3:hasSpineMask() then
			...
			slot0.loadSpineAnimator(slot4, slot0.loadSpineAnimator, slot2, function ()
				slot0(slot1)
			end)
		end
	end, true, true)
...
slot0.loadSpineAnimator = function (slot0, slot1, slot2, slot3)
...
slot0.MakeBoat = function (slot0, slot1, slot2)
...
slot0.LoadBoatMask = function (slot0, slot1, slot2, slot3)
...
slot0.LoadBoatEffect = function (slot0, slot1, slot2, slot3)
	slot5 = {}
...
slot0.LoadBoatPart = function (slot0, slot1, slot2, slot3)
	slot4 = {
		{
			"name",
			Vector3(0, 330, 0),
	...
	if not slot0.backyardresui then
		PoolMgr.GetInstance().GetUI(slot6, "backyardresui", true, function (slot0)
