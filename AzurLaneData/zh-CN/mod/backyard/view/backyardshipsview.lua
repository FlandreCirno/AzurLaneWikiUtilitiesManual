...
slot0.StartFolloweInterAction = function (slot0, slot1, slot2)
	...
	if slot0.view.followeModals[slot2] and slot3 then
		...
		slot4:SetLocalPosition(Vector3(slot4.furnitureVO.GetFollowerInterActionData(slot5)[1][1], slot4.furnitureVO.GetFollowerInterActionData(slot5)[1][2], 0))
		slot4:PlayAnim(slot4.furnitureVO.GetFollowerInterActionData(slot5)[2])
	end
end
