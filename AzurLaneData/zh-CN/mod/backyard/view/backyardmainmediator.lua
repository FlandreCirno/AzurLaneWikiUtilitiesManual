...
slot0.onRegister = function (slot0)
	...
	slot0:bind(slot0.GET_VISITOR_SHIP, function (slot0, slot1)
		pg.m02:sendNotification(GAME.BACKYARD_GET_VISITOR_SHIP, {
			callback = slot1
		})
	end)
	slot0.bind(slot0, slot0.ON_CLICK_SHIP, function (slot0)
	...
	slot0.bind(slot0, slot0.ADD_VISITOR_SHIP, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
			name = BACKYARD.ADD_VISITOR_SHIP,
			ship = slot1
		})
	end)
	slot0.bind(slot0, slot0.INTERACTION_TRANSPORT, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.RESET_BOAT_POS, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
			name = BACKYARD.RESET_BOAT_POS,
			id = slot1
		})
	end)
	slot0.bind(slot0, slot0.INTERACTION_TRANSPORT_AGAIN, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.INTERACTION_TRANSPORT_END, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.ON_ADD_MOVE_FURNITURE, function (slot0, slot1)
		slot0:addMoveForFurniture(slot1, 1)
	end)
	slot0.bind(slot0, slot0.ON_REMOVE_MOVE_FURNITURE, function (slot0, slot1)
		slot0:removeFurntureMove(slot1, 1)
	end)
	slot0.bind(slot0, slot0.ON_SPINE_EXTRA, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.ON_CLEAR_SPINR_EXTRA, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.END_DRAG_SHIP, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.CANCEL_SHIP_MOVE, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
			name = BACKYARD.CANCEL_BOAT_MOVE,
			id = slot1
		})
	end)
	slot0.bind(slot0, slot0.FURNITURE_POS_CHNAGE, function (slot0, slot1, slot2, slot3)
	...
	slot0.bind(slot0, slot0.ADD_BOAT_MOVE, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.FURNITURE_DIR_CHANGE, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_FURNITURE, {
			name = BACKYARD.FURNITURE_CHANGE_DIR,
			id = slot1
		})
	end)
	slot0.bind(slot0, slot0.REMOVE_FURNITURE, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_FURNITURE, {
			name = BACKYARD.FURNITURE_REMOVE,
			id = slot1
		})
	end)
	slot0.bind(slot0, slot0.REPLACE_PAPER, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_FURNITURE, {
			name = BACKYARD.REPALCE_PAPER,
			furniture = slot1
		})
	end)
	slot0.bind(slot0, slot0.SAVE_FURNITURE, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_FURNITURE, {
	...
	slot0.bind(slot0, slot0.ADD_INTIMACY, function (slot0, slot1)
		pg.m02:sendNotification(GAME.BACKYARD_ADD_INTIMACY, slot1)
	end)
	slot0.bind(slot0, slot0.ADD_MONEY, function (slot0, slot1)
		pg.m02:sendNotification(GAME.BACKYARD_ADD_MONEY, slot1)
	end)
	slot0.bind(slot0, slot0.EXTEND_BACKYARD_AREA, function (slot0)
		pg.m02:sendNotification(GAME.USE_ITEM, {
			count = 1,
			id = ITEM_BACKYARD_AREA_EXTEND
		})
	end)
	slot0.bind(slot0, slot0.OPEN_DECORATION, function (slot0)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_FURNITURE, {
	...
	slot0.bind(slot0, slot0.CLOSE_GARNITURE, function (slot0)
	...
	slot0.bind(slot0, slot0.RESTORE_FURNITURES, function (slot0)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_FURNITURE, {
			name = BACKYARD.RESTORE_FURNITURES
		})
	end)
	slot0.bind(slot0, slot0.BUY_EXTEND_BACKYARD_ITEM, function (slot0, slot1, slot2)
		pg.m02:sendNotification(GAME.SHOPPING, {
			id = slot1,
			count = slot2
		})
	end)
	slot0.bind(slot0, slot0.BOAT_POSITION_RESET, function (slot0)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
			name = BACKYARD.BOAT_POSITION_RESET
		})
	end)
	slot0.bind(slot0, slot0.INTERACTION, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.INTERACTION_SPINE, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.CLEAR_SPINE, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
			name = BACKYARD.CLEAR_SPINE,
			shipId = slot1
		})
	end)
	slot0.bind(slot0, slot0.INTERACTION_STAGE, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.ADD_MOVE_FURNITURE, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.CLEAR_STAGE_INTERACTION, function (slot0, slot1)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
			name = BACKYARD.CLEAR_STAGE_INTERACTION,
			shipId = slot1
		})
	end)
	slot0.bind(slot0, slot0.ON_HALF_MOVE, function (slot0, slot1, slot2)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, slot0.ON_CHECK_EFFECT, function (slot0)
		pg.backyard:sendNotification(BACKYARD.COMMAND_BACKYARD_FURNITURE, {
...
slot0.handleNotification = function (slot0, slot1)
	...
	elseif slot2 == BackYardHouseProxy.HOUSE_UPDATE then
		slot0.viewComponent.setHouse(slot4, slot3)
	...
	elseif slot2 == BackYardHouseProxy.BACKYARD_RESTORED then
		slot0.viewComponent:emit(slot0.SAVE_FURNITURE)
