...
slot0.ExistFollower = function (slot0)
	return slot0.followerId ~= nil
end

slot0.ClearFollower = function (slot0)
	slot0.followerId = nil
	slot0.followTime = 0
end

slot0.SetFollowTime = function (slot0, slot1)
	slot0.followTime = slot1 + pg.TimeMgr.GetInstance():GetServerTime()
end

slot0.ShouldStopFollowed = function (slot0)
	return slot0.followTime <= pg.TimeMgr.GetInstance():GetServerTime()
end

slot0.IsVisitor = function (slot0)
