...
slot0.NeedAlphaCheck = function (slot0)
...
slot0.IsRandomController = function (slot0)
...
slot0.getUniqueShipAction = function (slot0, slot1, slot2)
	...
	if _.detect(slot3, function (slot0)
		return _.any(slot0[2], function (slot0)
			return slot0 == (((slot0[5] and slot0[5] ~= 1) or nil.skinId) and nil.gruopId)
...
slot0.GetSpecailActiont = function (slot0, slot1)
	if slot0[slot0.configId] and _.detect(slot2.actions, function (slot0)
...
slot0.is3DObject = function (slot0)
...
slot0.getTouchSpineConfig = function (slot0)
	if slot0:isSpine() then
		...
		if Clone(slot0.getConfig("spine")[1][3] or [3]) then
...
slot0.IsFollower = function (slot0)
	return slot0:getConfig("type") == Furniture.TYPE_FOLLOWER
end

slot0.IsSpineRandomType = function (slot0)
	return slot0:IsFollower()
end

slot0.GetFollowerInterActionData = function (slot0)
	return slot0:getConfig("spine")[3]
end

slot0.ExistFollowBoneNode = function (slot0)
	return slot0:getConfig("followBone") ~= nil
end

slot0.GetFollowBone = function (slot0)
	return slot0:getConfig("followBone")[1], slot0.getConfig("followBone")[2] or 1
end

slot0.HasFollower = function (slot0)
