...
slot1 = {
	...
	__newindex = function (slot0, slot1, slot2)
		...
		while slot4 ~= nil and slot4 ~= slot0 do
...
slot0.Ctor = function (slot0)
	...
	while slot2 ~= nil and slot2 ~= slot0 do
...
slot0.Clear = function (slot0)
	slot0.super.ClearListeners(slot0)

	slot1 = rawget(slot0, "class")
	slot2 = rawget(slot0, "fields")

	while slot1 ~= nil and slot1 ~= slot0 do
	...
	if type(slot0) == "table" and instanceof(slot0, slot0) then
		...
		for slot7, slot8 in pairs(slot0) do
			if slot3 and slot7 == "class" then
				...
				slot2[slot0.Clone_Copy(slot7, slot1)] = slot0.Clone_Copy(slot8, slot1)
			end
		end
