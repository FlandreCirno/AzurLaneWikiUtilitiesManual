...
slot0.Ctor = function (slot0, slot1)
	slot0.maxTimePerFrame = math.min(slot1, slot0.MTPF)
	slot0.taskPool = {}
	slot0.taskQueue = {}
	slot0.running = false
...
slot0.Enqueue = function (slot0, slot1)
	(#slot0.taskPool > 0 and table.remove(slot0.taskPool, #slot0.taskPool)) or TSTask.New():SetJob(slot1)
	table.insert(slot0.taskQueue, (#slot0.taskPool > 0 and table.remove(slot0.taskPool, #slot0.taskPool)) or TSTask.New())
