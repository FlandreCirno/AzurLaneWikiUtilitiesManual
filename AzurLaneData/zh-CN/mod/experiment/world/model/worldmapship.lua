...
slot0.UpdateHpRant = function (slot0, slot1)
	if slot0.hpRant ~= slot1 then
		...
		slot0:DispatchEvent(slot0.EventHpRantChange)
	end
end
...
slot0.GetBuffList = function (slot0)
	...
	slot2 = slot0.fleetId and nowWorld.GetFleet(slot2, slot0.fleetId):GetDamageBuff()
...
slot0.AddBuff = function (slot0, slot1, slot2)
	...
	if slot1 == WorldConst.BrokenBuffId then
		slot0:DispatchEvent(slot0.EventUpdateBroken)
	end
...
slot0.GetShipBuffProperties = function (slot0)
	WorldConst.AppendPropertiesFromBuffList({}, {}, (slot0.fleetId and nowWorld:GetFleet(slot0.fleetId):GetBuffList()) or {})

	return , 
end

slot0.GetShipPowerBuffProperties = function (slot0)
	WorldConst.ExtendPropertiesRatesFromBuffList({}, slot0:GetBuffList())
