...
slot0.AddInMapTimer = function (slot0, slot1, slot2, slot3, slot4)
	table.insert(slot0.inMapTimers, Timer.New(slot1, slot2, slot3, slot4))

	return Timer.New(slot1, slot2, slot3, slot4)
end
...
slot0.AddTimer = function (slot0, slot1, slot2, slot3, slot4)
	table.insert(slot0.timers, Timer.New(slot1, slot2, slot3, slot4))
