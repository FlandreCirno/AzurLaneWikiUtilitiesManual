...
slot0.Setup = function (slot0, slot1)
	...
	for slot6 = 0, GetComponent(slot1, "ItemList").prefabItem.Length - 1, 1 do
...
slot0.Get = function (slot0, slot1)
	...
	setActive((#slot3 <= 0 or table.remove(slot3, #slot3)) and Instantiate(slot0.tplDic[slot1]), true)
	tf((#slot3 <= 0 or table.remove(slot3, #slot3)) and Instantiate(slot0.tplDic[slot1])):SetParent(slot0.pooltf, false)

	return (#slot3 <= 0 or table.remove(slot3, #slot3)) and Instantiate(slot0.tplDic[slot1])
end
