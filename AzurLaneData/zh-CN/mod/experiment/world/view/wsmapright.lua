...
slot0.Init = function (slot0)
	slot0.rtCompassPanel = slot0.transform.Find(slot1, "compass_panel")
	...
	slot0.toggleSkipPrecombat = slot0.transform.Find(slot1, "btn_list/lock_fleet")
	...
	slot0.toggleAutoFight = slot1.Find(slot1, "btn_list/auto_fight")
...
slot0.UpdateCompass = function (slot0)
	slot0:UpdateCompassMarks()
	slot0:UpdateCompassRotation(slot0.map.GetFleet(slot1))
end
...
slot0.UpdateExit = function (slot0)
	setActive(slot0.btnExit, slot0.map:canExit())
end

slot0.OnUpdateInfoBtnTip = function (slot0)
	setActive(slot0.btnInformation.Find(slot3, "tip"), _.any(slot0.taskProxy:getTaskVOs(), function (slot0)
