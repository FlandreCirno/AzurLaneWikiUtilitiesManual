	...
	effect_list = {
		{
			...
			arg_list = {
				...
				centerPosFun = function (slot0)
					return Vector3(math.sin(slot1) * 8, 0.75, math.cos(slot0 * 3) * 8)
				end,
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function (slot0)
					return Vector3(math.sin(slot1) * 8, 0.75, math.cos(slot0 * 3 + ys.Battle.BattleConfig.SHIELD_CENTER_CONST_2) * 8)
				end,
				rotationFun = function (slot0)
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function (slot0)
					return Vector3(math.sin(slot1) * 8, 0.75, math.cos(slot0 * 3 + ys.Battle.BattleConfig.SHIELD_CENTER_CONST_4) * 8)
				end,
				rotationFun = function (slot0)
