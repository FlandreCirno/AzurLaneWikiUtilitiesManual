	...
	effect_list = {
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function (slot0)
					return Vector3(math.sin(slot1) * 3, 0.75, math.cos(slot0 * 3 + 1.256) * 3)
				end,
				rotationFun = function (slot0)
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function (slot0)
					return Vector3(math.sin(slot1) * 3, 0.75, math.cos(slot0 * 3 + 2.512) * 3)
				end,
				rotationFun = function (slot0)
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function (slot0)
					return Vector3(math.sin(slot1) * 5, 0.75, math.cos(slot0 * 3 + 1.256) * 5)
				end,
				rotationFun = function (slot0)
					return Vector3(0, slot0 * ys.Battle.BattleConfig.SHIELD_ROTATE_CONST + 162, 0)
				end
		...
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function (slot0)
					return Vector3(math.sin(slot1) * 5, 0.75, math.cos(slot0 * 3 + 2.512) * 5)
				end,
				rotationFun = function (slot0)
					return Vector3(0, slot0 * ys.Battle.BattleConfig.SHIELD_ROTATE_CONST + 234, 0)
				end
