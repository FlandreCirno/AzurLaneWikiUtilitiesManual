...
slot0.display = function (slot0)
	...
	slot1.align(slot1, #ChatConst.EmojiTypes)
...
slot0.filter = function (slot0, slot1)
	...
	slot3 = slot0.emojiProxy.getNewEmojiIDLIst(slot3)
	...
	if slot1 == ChatConst.EmojiCommon then
		...
		slot9 = _.map(slot8, function (slot0)
			return pg.emoji_template[slot0.id]
		end)
		slot2 = slot9
	else
		slot6 = _.filter(slot2, function (slot0)
	...
	for slot10 = 0, slot0.emojiContent.childCount - 1, 1 do
		...
		slot13.align(slot13, #_.slice(slot2, slot10 * slot0.PageEmojiNums + 1, slot0.PageEmojiNums))
	end
end
...
slot0.emojiIconFliter = function (slot0)
	...
	for slot9 = slot0.emojiIconContent.childCount + 1, slot5, 1 do
		...
		if slot9 == 1 then
			...
			slot19.align(slot19, slot0.True_Emoji_Num_Of_Page - slot0.Frequently_Used_Emoji_Num)
		else
			...
			slot19.align(slot19, #_.slice(slot1, (slot9 - 2) * slot0.True_Emoji_Num_Of_Page + 9 + 1, slot0.True_Emoji_Num_Of_Page))
		end
