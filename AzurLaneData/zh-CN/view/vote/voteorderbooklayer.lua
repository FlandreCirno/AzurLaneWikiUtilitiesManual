...
slot0.init = function (slot0)
	...
	slot0.sucess = slot0.findTF(slot0, "window/main/sucess")
	...
	slot0.awardCntTF = slot0.findTF(slot0, "window/main/award"):GetComponent(typeof(Text))
	...
	function slot1(slot0, slot1, slot2)
		if slot2 then
			...
			onButton(slot0, slot3, function ()
				...
				slot1[slot2] = (slot1.opRecords[Vector3(-slot0.localScale.x, 1, 1)] ~= 1 or 0) and 1
			end, SFX_PANEL)
		end
	end
...
slot0.PlayAnim = function (slot0, slot1, slot2)
	if slot1 then
		...
		slot0.failedAnim.Play(slot3, "blink")
