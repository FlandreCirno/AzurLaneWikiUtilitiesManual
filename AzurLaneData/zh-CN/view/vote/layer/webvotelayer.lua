...
slot0.didEnter = function (slot0)
	...
	setActive(slot0.helpBtn, slot0.voteGroup.getConfig(slot1, "help_text") and slot1 ~= "")
	...
	slot0.ships = slot0.PAGES[slot0.voteGroup.id][1].New(slot0.findTF(slot0, "main/right_panel"), slot0.event)
