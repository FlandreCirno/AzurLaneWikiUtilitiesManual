...
slot0.register = function (slot0)
	slot0:bind(slot0.OnSwitchShip, function (slot0, slot1, slot2, slot3)
		nowWorld.GetFleet(slot4, slot1):SwitchShip(slot2, slot3)
	end)
	slot0.bind(slot0, slot0.OnAuto, function (slot0, slot1)
		slot0:onAutoBtn(slot1)
	end)
	slot0.bind(slot0, slot0.OnSubAuto, function (slot0, slot1)
		slot0:onSubAuto(slot1)
	end)
	slot0.bind(slot0, slot0.OnMapOp, function (slot0, slot1)
		slot0:sendNotification(GAME.WORLD_MAP_OP, slot1)
	end)
	slot0.bind(slot0, slot0.OnStartBattle, function (slot0, slot1, slot2, slot3)
	...
	slot0.bind(slot0, slot0.OnOpenSublayer, function (slot0, slot1, slot2, slot3)
		slot0:addSubLayers(slot1, slot2, slot3)
	end)
