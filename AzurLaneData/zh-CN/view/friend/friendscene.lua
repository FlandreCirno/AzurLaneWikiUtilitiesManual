...
slot0.removeSearchResult = function (slot0, slot1)
	slot0.setSearchResult(slot0, _.select(slot0.searchResultVOs, function (slot0)
...
slot0.init = function (slot0)
	...
	slot0.chatTipContainer = slot0.toggles[1].Find(slot1, "count")
...
slot0.switchPage = function (slot0, slot1)
	...
	slot0.pages[slot1].ExecuteAction(slot2, "Show")
