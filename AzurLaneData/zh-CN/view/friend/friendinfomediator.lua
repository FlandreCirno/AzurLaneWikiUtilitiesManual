...
slot0.register = function (slot0)
	...
	slot0:bind(slot0.INFORM_BACKYARD, function (slot0, slot1, slot2, slot3, slot4)
		slot0:sendNotification(GAME.INFORM_THEME_TEMPLATE, {
			uid = slot1,
			content = slot2,
			tid = slot3,
			playerName = slot4
	...
	slot0.bind(slot0, slot0.OPEND_FRIEND, function (slot0)
	...
	slot0.bind(slot0, slot0.OPEN_RESUME, function (slot0)
	...
	slot0.bind(slot0, slot0.TOGGLE_BLACK, function (slot0)
	...
	slot0.bind(slot0, slot0.INFORM, function (slot0, slot1, slot2, slot3)
	...
	if not getProxy(FriendProxy).getBlackList(slot2) then
