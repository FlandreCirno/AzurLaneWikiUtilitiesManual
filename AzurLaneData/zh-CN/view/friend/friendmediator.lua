...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.SEARCH_FRIEND, function (slot0, slot1, slot2)
		slot0:sendNotification(GAME.FRIEND_SEARCH, {
			type = slot1,
			keyword = slot2
		})
	end)
	slot0.bind(slot0, slot0.OPEN_CHATROOM, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.ADD_FRIEND, function (slot0, slot1, slot2)
		slot0:sendNotification(GAME.FRIEND_SEND_REQUEST, {
			id = slot1,
			msg = slot2
		})
	end)
	slot0.bind(slot0, slot0.ACCEPT_REQUEST, function (slot0, slot1)
		slot0:sendNotification(GAME.FRIEND_ACCEPT_REQUEST, slot1)
	end)
	slot0.bind(slot0, slot0.REFUSE_ALL_REQUEST, function (slot0)
		slot0:sendNotification(GAME.FRIEND_REJECT_REQUEST, 0)
	end)
	slot0.bind(slot0, slot0.REFUSE_REQUEST, function (slot0, slot1, slot2)
	...
	slot0.bind(slot0, slot0.DELETE_FRIEND, function (slot0, slot1)
		slot0:sendNotification(GAME.FRIEND_DELETE, slot1)
	end)
	slot0.bind(slot0, slot0.OPEN_RESUME, function (slot0, slot1)
		slot0:sendNotification(GAME.FRIEND_SEARCH, {
			type = SearchFriendCommand.SEARCH_TYPE_RESUME,
			keyword = slot1
		})
	end)
	slot0.bind(slot0, slot0.OPEN_RESUME_BY_VO, function (slot0, slot1)
		slot0:openResume(slot1)
	end)
	slot0.bind(slot0, slot0.VISIT_BACKYARD, function (slot0, slot1)
		slot0:sendNotification(GAME.VISIT_BACKYARD, slot1)
	end)
	slot0.bind(slot0, slot0.RELIEVE_BLACKLIST, function (slot0, slot1)
		slot0:sendNotification(GAME.FRIEND_RELIEVE_BLACKLIST, slot1)
	end)
	slot0.updateChatNotification(slot0)
end
