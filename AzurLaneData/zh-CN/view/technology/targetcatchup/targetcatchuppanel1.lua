...
slot0.Ctor = function (slot0, slot1, slot2)
	...
	PoolMgr.GetInstance():GetUI("TargetCatchupPanel1", true, function (slot0)
...
slot0.updateShowPanel = function (slot0)
	...
	slot2 = slot0.technologyProxy:getCurCatchupTecInfo().tecID

	setImageSprite(slot0.showBG, LoadSprite("TecCatchup/selbg" .. slot3, slot3))
	setText(slot0.nameText, slot5)
	setText(slot0.progressText, slot4 .. "/" .. slot0:getMaxNum(slot0.technologyProxy.getCurCatchupTecInfo().groupID))
