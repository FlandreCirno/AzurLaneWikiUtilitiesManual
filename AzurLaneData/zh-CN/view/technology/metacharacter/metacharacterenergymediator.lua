...
slot0.register = function (slot0)
	slot0:bind(slot0.ON_ACTIVATION, function (slot0, slot1)
		slot0:sendNotification(GAME.ENERGY_META_ACTIVATION, {
			shipId = slot1
		})
	end)
	slot0.bind(slot0, slot0.ON_PREVIEW, function (slot0, slot1, slot2)
