...
slot0.updateDetail = function (slot0)
	...
	slot1 = pg.fleet_tech_ship_template[slot0.groupID].pt_get
	...
	slot6.align(slot6, #pg.fleet_tech_ship_template[slot0.groupID].add_get_shiptype)
	...
	slot10.align(slot10, #pg.fleet_tech_ship_template[slot0.groupID].add_level_shiptype)
end
