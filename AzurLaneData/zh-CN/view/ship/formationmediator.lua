...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.CHANGE_FLEET_NAME, function (slot0, slot1, slot2)
	...
	slot0.bind(slot0, slot0.OPEN_SHIP_INFO, function (slot0, slot1, slot2, slot3)
		function slot4()
		...
		slot0.commitEdit(slot4)
	end)
	slot0.bind(slot0, slot0.ON_CHANGE_FLEET, function (slot0, slot1)
		slot0.commitEdit(function ()
	...
	slot0.bind(slot0, slot0.CHANGE_FLEET_FORMATION, function (slot0, slot1, slot2)
	...
	slot0.bind(slot0, slot0.CHANGE_FLEET_SHIP, function (slot0, slot1, slot2, slot3, slot4)
		...
		slot15.onShip, slot15.confirmSelect, slot15.onSelected = slot1.getDockCallbackFuncs(slot0, slot1, slot2, slot4)
	...
	slot0.viewComponent:setPlayer(getProxy(PlayerProxy).getData(slot5))
end
