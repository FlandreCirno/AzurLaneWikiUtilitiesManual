...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, CollectionScene.SHOW_DETAIL, function (slot0, slot1, slot2)
		slot0:sendNotification(GAME.GO_SCENE, SCENE.SHIP_PROFILE, {
			showTrans = slot1,
			groupId = slot2
		})
	end)
	slot0.bind(slot0, CollectionScene.ACTIVITY_OP, function (slot0, slot1)
		slot0:sendNotification(GAME.ACTIVITY_OPERATION, slot1)
	end)
	slot0.bind(slot0, CollectionScene.BEGIN_STAGE, function (slot0, slot1)
		slot0:sendNotification(GAME.BEGIN_STAGE, slot1)
	end)
	slot0.bind(slot0, CollectionScene.ON_INDEX, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.EVENT_OPEN_FULL_SCREEN_PIC_VIEW, function (slot0, slot1)
		slot0:addSubLayers(Context.New({
	...
	slot0.viewComponent.updateCollectNotices(slot3, slot0.collectionProxy:hasFinish())
end
