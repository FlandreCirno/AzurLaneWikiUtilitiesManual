...
function slot4(slot0, slot1, slot2)
	if (not slot0.live2dAction or slot2) and slot0.action2Id[slot1] then
...
function slot6(slot0, slot1)
	...
	slot0.liveCom.SetTouchParts(slot3, slot0.assistantTouchParts)
...
slot0.Ctor = function (slot0, slot1, slot2)
	...
	pg.Live2DMgr.GetInstance().GetLive2DModelAsync(slot5, slot0.live2dData:GetShipName(), function (slot0)
