...
slot0.flushShip = function (slot0)
	...
	LoadImageSpriteAsync("shipYardIcon/" .. slot3, slot0.iconShip)
...
slot0.flushEva = function (slot0)
	...
	for slot6 = 1, #slot2, 1 do
		...
		SetActive((not slot2[slot6].hot or cloneTplTo(slot0.hotTpl, slot0.hotContent)) and cloneTplTo(slot0.commonTpl, slot0.commonContent).Find(slot7, "bg/zan_bg/down"), not LOCK_DOWNVOTE or false)
