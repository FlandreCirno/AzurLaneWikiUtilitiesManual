...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.SHIP_EXCHANGE, function (slot0, slot1)
		slot0:sendNotification(GAME.EXCHANGE_SHIP, {
			index = slot1
		})
	end)
	slot0.bind(slot0, slot0.GET_EXCHANGE_ITEMS, function (slot0)
		slot0:sendNotification(GAME.GET_EXCHANGE_ITEMS, {
			type = 0
		})
	end)
	slot0.bind(slot0, slot0.ITEM_EXCHANGE, function (slot0, slot1)
