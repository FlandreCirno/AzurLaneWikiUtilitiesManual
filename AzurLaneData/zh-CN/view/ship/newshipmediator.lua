...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_SKIP_BATCH, function (slot0, slot1, slot2)
	...
	slot0.bind(slot0, slot0.ON_SKILLINFO, function (slot0, slot1, slot2)
	...
	slot0.bind(slot0, slot0.ON_EVALIATION, function (slot0, slot1)
		slot0:sendNotification(GAME.FETCH_EVALUATION, slot1)
	end)
	slot0.sendNotification(slot0, slot0.OPEN, {})
end
