...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, ShipProfileScene.SHOW_SKILL_INFO, function (slot0, slot1, slot2)
		slot0:addSubLayers(Context.New({
	...
	slot0.bind(slot0, ShipProfileScene.SHOW_EVALUATION, function (slot0)
		slot0:sendNotification(GAME.FETCH_EVALUATION, slot0.groupId)
	end)
	slot0.bind(slot0, ShipProfileScene.WEDDING_REVIEW, function (slot0, slot1)
		slot0:addSubLayers(Context.New({
