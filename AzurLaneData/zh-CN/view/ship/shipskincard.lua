...
slot0.updateData = function (slot0, slot1, slot2, slot3)
	if slot0.ship ~= slot1 or slot0.skin ~= slot2 or slot0.own ~= slot3 then
		...
		for slot9 = 0, slot0.tags.childCount - 1, 1 do
			setActive(slot0.tags.GetChild(slot11, slot9), false)
		end
...
slot0.loadPainting = function (slot0)
	...
	setActive(slot0.hideObjToggle, (slot0.skin and slot0.skin.painting) or "unknown")
