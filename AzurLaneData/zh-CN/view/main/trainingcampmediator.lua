...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_SELECTABLE_GET, function (slot0, slot1, slot2)
		slot0:sendNotification(GAME.SUBMIT_TASK, {
			taskId = slot1.id,
			index = slot2
		})
	end)
	slot0.bind(slot0, slot0.ON_GET, function (slot0, slot1)
		slot0:sendNotification(GAME.SUBMIT_TASK, slot1.id)
	end)
	slot0.bind(slot0, slot0.ON_GO, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.ON_TRIGGER, function (slot0, slot1)
