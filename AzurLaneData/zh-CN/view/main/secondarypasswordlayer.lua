...
slot0.init = function (slot0)
	...
	slot0.btnconfirm = slot0.findTF(slot0, "confirmbtn", slot0.inputpanel)
...
slot0.InitInteractable = function (slot0)
	...
	onButton(slot0, slot0.btndelete, function ()
		...
		if slot0.timers.btndel then
			slot0.timers.btndel.Reset(slot2, slot1, 0.3, 1)
		else
		...
		if slot0.mode == slot1.InputView then
			...
			slot5 = {
				...
				onYes = function ()
					...
					pg.MsgboxMgr.GetInstance().ShowMsgBox(slot1, pg.MsgboxMgr.GetInstance().ShowMsgBox)
				end,
				onNo = function ()
