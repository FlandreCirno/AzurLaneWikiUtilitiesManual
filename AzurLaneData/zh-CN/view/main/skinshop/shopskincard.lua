...
slot0.Ctor = function (slot0, slot1, slot2)
	...
	onButton(nil, slot0._go, function ()
		slot0.view:emit(SkinShopScene.EVENT_ON_CARD_CLICK, slot0.view.emit)
	end, SFX_PANEL)
end
...
slot0.update = function (slot0, slot1)
	...
	if slot0.goodsVO.type == Goods.TYPE_SKIN then
		slot0._priceIcon.sprite = LoadSprite(pg.item_data_statistics[id2ItemId(slot5)].icon)
		...
		elseif slot12 then
			...
			if slot9 or slot14 == 5 then
				setText(slot0._tagTFs[5].Find(slot15, "Text"), slot11 .. "%")
