...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.CHANGE_ROOM, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.BATTLE_CHAT_CLOSE, function (slot0)
		slot0:sendNotification(BattleMediator.CLOSE_CHAT)
	end)
	slot0.bind(slot0, slot0.OPEN_INFO, function (slot0, slot1, slot2, slot3)
