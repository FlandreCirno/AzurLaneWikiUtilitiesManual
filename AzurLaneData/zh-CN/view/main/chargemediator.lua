...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.GET_CHARGE_LIST, function (slot0)
	...
	slot0.bind(slot0, slot0.CHARGE, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.CLICK_MING_SHI, function (slot0)
...
slot0.handleNotification = function (slot0, slot1)
	...
	elseif slot2 == GAME.SHOPPING_DONE then
		...
		elseif slot7[slot3.id].group > 0 and _.detect(slot0.viewComponent.itemVOs, function (slot0)
			...
			slot13 = slot0.viewComponent.getGroupLimit(slot12, slot11:getConfig("group")) == slot11:getConfig("group_limit")
