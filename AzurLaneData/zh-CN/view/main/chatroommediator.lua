...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.FETCH_FRIEND_MSG, function (slot0, slot1)
		slot0:sendNotification(GAME.FRIEND_FETCH_MSG, slot1)
	end)
	slot0.bind(slot0, slot0.CLEAR_UNREADCOUNT, function (slot0, slot1)
	...
	slot0.viewComponent.setFriends(slot6, slot4)
