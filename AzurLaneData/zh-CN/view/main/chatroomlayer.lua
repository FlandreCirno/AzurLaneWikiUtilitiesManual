...
slot0.createFriendItem = function (slot0, slot1)
	...
	return {
		...
		update = function (slot0, slot1, slot2)
			...
			slot0.dateTF.text = pg.TimeMgr.GetInstance().STimeDescC(slot7, slot1.preOnLineTime, "%Y/%m/%d")
		end,
...
slot0.sortFriend = function (slot0)
	...
	slot0.friendRect.SetTotalCount(slot1, #slot0.friendVOs, -1)
end
