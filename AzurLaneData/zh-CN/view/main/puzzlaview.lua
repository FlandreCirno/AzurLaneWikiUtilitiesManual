...
slot0.disorganizePuzzla = function (slot0, slot1)
	...
	if slot1 and #slot1 > 0 then
		slot0.orderDisorganize(slot0, slot1, slot0, function (slot0)
			slot0.paths = slot0
		...
		for slot6 = 1, slot1, 1 do
			table.insert(slot0.paths, slot0.disorganizeStep(slot0))

			slot0.prevDir = slot2[slot0.disorganizeStep(slot0)]
		end
