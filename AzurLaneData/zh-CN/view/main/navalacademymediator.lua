...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.OPEN_TROPHY_GALLERY, function (slot0, slot1)
		slot0:addSubLayers(Context.New({
	...
	slot0.bind(slot0, slot0.GET_RES, function (slot0, slot1)
		slot0:sendNotification(GAME.HARVEST_RES, slot1)
	end)
	slot0.bind(slot0, slot0.UPGRADE_FIELD, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.UPGRADE_TIMES_UP, function (slot0, slot1)
		slot0:UpgradeFinish()
	...
	slot0.bind(slot0, slot0.ACTIVITY_OP, function (slot0, slot1)
		slot0:sendNotification(GAME.ACTIVITY_OPERATION, slot1)
	end)
	slot0.bind(slot0, slot0.TASK_GO, function (slot0, slot1)
		slot0:sendNotification(GAME.TASK_GO, slot1)
	end)
	slot0.bind(slot0, slot0.GO_TASK_SCENE, function (slot0, slot1)
		slot0:sendNotification(GAME.GO_SCENE, SCENE.TASK, slot1)
	end)
	slot0.bind(slot0, slot0.OPEN_CLASS, function (slot0)
	...
	slot0.bind(slot0, slot0.OPEN_ACTIVITY_SHOP, function (slot0)
		slot0:sendNotification(GAME.GO_SCENE, SCENE.SHOP, {
