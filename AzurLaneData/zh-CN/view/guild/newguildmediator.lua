...
slot0.register = function (slot0)
	...
	slot0:bind(slot0.OPEN_PUBLIC_GUILD, function (slot0)
		slot0:sendNotification(GAME.GO_SCENE, SCENE.PUBLIC_GUILD)
	end)
	slot0.bind(slot0, slot0.OPEN_GUILD_LIST, function (slot0)
		slot0:addSubLayers(Context.New({
			viewComponent = JoinGuildLayer,
			mediator = JoinGuildMediator
		}))
	end)
	slot0.bind(slot0, slot0.CREATE, function (slot0, slot1)
