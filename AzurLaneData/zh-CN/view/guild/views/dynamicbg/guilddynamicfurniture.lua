...
slot0.SetPosition = function (slot0, slot1)
	slot0._tf.localPosition = Vector3(slot1:GetLocalPosition().x + slot0.offset.x, slot1.GetLocalPosition().y + slot0.offset.y, 0)
	slot0.grid = slot1
...
slot0.GetOccupyGrid = function (slot0)
	...
	for slot6 = 0, slot0.size.x - 1, 1 do
		for slot10 = 0, slot0.size.y - 1, 1 do
