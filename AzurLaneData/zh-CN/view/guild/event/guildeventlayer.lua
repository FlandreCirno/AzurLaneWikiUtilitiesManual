...
slot0.init = function (slot0)
	slot0:bind(slot0.OPEN_EVENT_INFO, function (slot0, slot1)
		slot0.eventInfoPage:ExecuteAction("Show", slot0.guildVO, slot0.player, {
			gevent = slot1
		})
	end)
	slot0.bind(slot0, slot0.ON_OPEN_FORMATION, function (slot0)
		slot0.formationPage:ExecuteAction("Show", slot0.guildVO, slot0.player, {
			fleet = slot0.myAssaultFleet
		})
	end)
	slot0.bind(slot0, slot0.ON_OPEN_MISSION, function (slot0, slot1)
		slot0.missionInfoPage:ExecuteAction("Show", slot0.guildVO, slot0.player, {
			mission = slot1
		})
	end)
	slot0.bind(slot0, slot0.OPEN_MISSION_FORAMTION, function (slot0, slot1)
		slot0.missionFormationPage:ExecuteAction("Show", slot0.guildVO, slot0.player, {
			mission = slot1,
			shipCnt = GuildConst.MISSION_MAX_SHIP_CNT
		})
	end)
	slot0.bind(slot0, slot0.ON_OPEN_BOSS, function (slot0, slot1)
		slot0.missionBossPage:ExecuteAction("Show", slot1)
	end)
	slot0.bind(slot0, slot0.ON_OPEN_BOSS_FORMATION, function (slot0, slot1)
		slot0.missBossForamtionPage:ExecuteAction("Show", slot0.guildVO, slot0.player, {
			mission = slot1
		})
	end)
	slot0.bind(slot0, slot0.OPEN_BOSS_ASSULT, function ()
		slot0.showAssultShipPage:ExecuteAction("Show", slot0.guildVO, slot0.player)
	end)
	slot0.bind(slot0, slot0.SHOW_SHIP_EQUIPMENTS, function (slot0, slot1, slot2, slot3)
		slot0.shipEquipmentsPage:ExecuteAction("Show", slot1, slot2, slot3)
	end)
	...
	slot0.helpBtn = slot0.findTF(slot0, "frame/help")
end
