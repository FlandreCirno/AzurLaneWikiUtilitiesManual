...
slot0.Flush = function (slot0, slot1, slot2)
	...
	if slot2:GetLeftTime() < 86400 then
		slot0.timer = Timer.New(function ()
			slot0:UpdateText("<size=31><color=#FF3838>" .. pg.TimeMgr.GetInstance():DescCDTime(slot0:GetLeftTime()) .. "</color></size>")
		...
		slot4, slot5, slot6, slot7 = pg.TimeMgr.GetInstance().parseTimeFrom(slot4, slot3)
