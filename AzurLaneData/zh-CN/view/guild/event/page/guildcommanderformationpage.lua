...
slot0.OnInit = function (slot0)
	...
	onButton(slot0, slot0.restAllBtn, function ()
		if not slot0.fleet:ExistAnyCommander() then
			return
		end

		slot0:emit(GuildEventMediator.COMMANDER_FORMATION_OP, {
			data = {
				fleet = slot0.fleet,
...
slot0.openDescPanel = function (slot0, slot1)
	...
	LeanTween.moveX(slot0.samllTF, 1500, slot2):setOnComplete(System.Action(function ()
		...
		LeanTween.moveX(slot0.descFrameTF, -108, )
	end))

	slot0.contextData.inDescPage = true

	slot0._tf.SetAsLastSibling(slot3)
end
...
slot0.closeDescPanel = function (slot0, slot1)
	...
	LeanTween.moveX(slot0.descFrameTF, 1500, slot2):setOnComplete(System.Action(function ()
		...
		LeanTween.moveX(slot0.samllTF, -108, )
	end))
...
slot0.updateAdditions = function (slot0)
	...
	slot0.talentsTF:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			...
			setText(slot2:Find("Text"), ((slot3.value > 0 and "+") or "") .. slot3.value .. ((slot0[slot1 + 1].type == CommanderConst.TALENT_ADDITION_RATIO and "%") or ""))
			setImageAlpha(slot2:Find("bg"), slot1 % 2)
		end
	end)
...
slot0.updateSkillTF = function (slot0, slot1, slot2)
	...
	if slot1 then
		...
		onButton(slot0, slot2, function ()
			slot0:emit(GuildEventMediator.ON_CMD_SKILL, slot0)
		end, SFX_PANEL)
...
slot0.updateCommander = function (slot0, slot1, slot2, slot3, slot4)
	...
	if slot4 then
		onButton(slot0, slot6, function ()
			slot0:emit(GuildEventMediator.ON_SELECT_COMMANDER, slot0.fleet.id, slot0, )
		end, SFX_PANEL)
...
slot0.UpdatePrefabFleet = function (slot0, slot1, slot2, slot3)
	onInputEndEdit(slot0, slot4, function ()
		getInputText:emit(GuildEventMediator.COMMANDER_FORMATION_OP, {
			data = {
				fleet = slot1.fleet,
