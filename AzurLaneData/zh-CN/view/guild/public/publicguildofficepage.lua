...
slot0.OnInit = function (slot0)
	...
	slot0.itemList:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			slot0:UpdateDonateTask(slot2, slot0.displays[slot1 + 1])
		end
	end)
end
...
slot0.UpdateDonateTask = function (slot0, slot1, slot2)
	slot4 = slot0.guild.GetRemainDonateCnt(slot3)
	...
	onButton(slot0, slot5.commitBtn, function ()
		...
		pg.MsgboxMgr:GetInstance():ShowMsgBox({
			content = i18n("guild_donate_tip", slot2.cfg.name, slot1[3], slot3, (slot0:GetResCntByAward(slot0.dtask.getCommitItem(slot0)) < slot0.dtask.getCommitItem(slot0)[3] and "#FF5C5CFF") or "#92FC63FF"),
			onYes = function ()
				slot0:emit(PublicGuildMainMediator.ON_COMMIT, slot1.id)
			end
		})
	end, SFX_PANEL)
