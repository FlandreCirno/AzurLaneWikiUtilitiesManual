...
slot0.CanJump = function (slot0)
	return not slot0:IsDeath() and slot0.state ~= slot0 and slot0.isStand
end
...
slot0.BeInjured = function (slot0)
	...
	if slot0.prevMoveDir == slot0 then
		slot1.x = -slot1.x
	end
...
slot0.SendPlayerEvent = function (slot0, slot1, ...)
	slot0.view.map:GetPlayer()[slot1](slot0.view.map.GetPlayer(), unpack({
		...
	}))
end
