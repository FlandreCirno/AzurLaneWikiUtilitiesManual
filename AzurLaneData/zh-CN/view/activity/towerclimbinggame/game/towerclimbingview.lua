...
slot0.OnEnter = function (slot0, slot1)
	...
	onButton(slot0, slot0.exitGameBtn, function ()
		slot0:ShowQuitPanel()
	end, SFX_PANEL)

	for slot5, slot6 in ipairs(slot0.maps) do
		onButton(slot0, slot6, function ()
			slot0.controller:StartGame(slot0.controller)
		end, SFX_PANEL)
	end
end
...
slot0.DoEnter = function (slot0, slot1)
	...
	slot0.timer = Timer.New(function ()
		...
		slot1.enterPanelTxt.text = slot1.enterPanelTxt

		if slot1.enterPanelTxt == 0 then
			slot2()
			slot1:ActivePanel(slot1.enterPanel, false)
			slot1.timer:Stop()

			slot1.timer.timer = nil
			nil.inDownCnt = nil
		end
	end, 1, -1)
...
slot0.OnStartGame = function (slot0)
	slot0(slot0.jumpBtn, function ()
		slot0.controller:PlayerJump()
		pg.CriMgr.GetInstance():PlaySoundEffect_V3(SFX_PANEL)
	end)
	slot0.OnSlip(slot0, slot0.moveBtn, function ()
...
slot0.OnSlip = function (slot0, slot1, slot2, slot3, slot4, slot5)
	...
	slot8 = GameObject.Find("UICamera"):GetComponent("Camera").WorldToScreenPoint(slot7, slot0.leftLayout.position)
	slot9 = 0
	slot10 = 10

	slot6.AddPointDownFunc(slot6, function (slot0, slot1)
		slot1(0, slot1)
	end)
	slot6.AddDragFunc(slot6, slot11)
...
slot0.OnEndGame = function (slot0, slot1, slot2)
	slot0:ResetParams()
...
slot0.ShowQuitPanel = function (slot0)
	...
	onButton(slot0, slot0.quitPanelCconfirmBtn, function ()
		slot0:ActivePanel(slot0.quitPanel, false)
		slot0.ActivePanel.controller:EndGame()
	end, SFX_PANEL)
...
slot0.ShowResultPanel = function (slot0, slot1, slot2)
	...
	onButton(slot0, slot0.resultPanelEndBtn, function ()
		...
		slot0.ActivePanel.controller:ExitGame()
	end, SFX_PANEL)
end
