...
slot0.updateBooks = function (slot0)
	for slot4, slot5 in ipairs(slot0.books) do
		setActive(slot5:Find("lock"), not (slot4 <= slot0.gotRewardIndex + 1))

		slot5:GetComponent(typeof(Image)).color = (slot4 <= slot0.gotRewardIndex + 1 and Color.New(1, 1, 1, 1)) or Color.New(0.46, 0.46, 0.46, 1)
...
slot0.OpenBook = function (slot0, slot1)
	...
	setActive(slot0.goBtn, slot3 == slot0.allDatas[slot1])
	onButton(slot0, slot0.getBtn, function ()
		slot0:emit(JiuJiuExpeditionCollectionMediator.ON_GET, slot0)
	end, SFX_PANEL)
...
slot0.UpdatePage = function (slot0, slot1, slot2, slot3)
	slot0.scoreList:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			...
			setActive(slot2:Find("lock"), not slot3("JiuJiuExpeditionCollectionIcon/" .. slot1 .. "_" .. slot1 + 1 + slot2, slot1, slot0[slot1 + 1]))
		end
	end)
