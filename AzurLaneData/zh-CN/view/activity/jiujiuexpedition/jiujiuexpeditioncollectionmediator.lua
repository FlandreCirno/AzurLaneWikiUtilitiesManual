...
slot0.register = function (slot0)
	...
	slot7, slot8, slot9, slot10 = JiuJiuExpeditionCollectionMediator.GetCollectionData()

	slot0.viewComponent.SetData(slot5, slot1, slot2, slot3, slot4)
end

slot0.GetCollectionData = function ()
	slot2 = pg.activity_event_adventure[1].boss_list
	slot3 = {}
	slot4 = getProxy(ActivityProxy):getActivityById(slot0)
	...
	for slot12 = 1, #slot1.boss_list, 1 do
		slot14 = 0

		for slot18 = 1, #slot1.boss_list[slot12], 1 do
...
slot0.handleNotification = function (slot0, slot1)
	...
	if slot1:getName() == ActivityProxy.ACTIVITY_UPDATED and slot3.id == slot0 then
		slot10, slot11, slot12, slot13 = JiuJiuExpeditionCollectionMediator.GetCollectionData()
