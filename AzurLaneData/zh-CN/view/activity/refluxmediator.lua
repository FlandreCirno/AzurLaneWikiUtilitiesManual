...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.OnTaskGo, function (slot0, slot1)
		slot0:sendNotification(GAME.TASK_GO, {
			taskVO = slot1
		})
	end)
	slot0.bind(slot0, slot0.OnBattlePhaseForward, function (slot0, slot1)
	...
	slot0.viewComponent.SetActivity(slot7, slot2)
