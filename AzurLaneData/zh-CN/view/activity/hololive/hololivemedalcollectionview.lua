...
slot0.AddListener = function (slot0)
	...
	slot1 = slot0.findTF(slot0, "middle/board/arrow")
...
slot0.UpdateView = function (slot0)
	...
	for slot7 = 1, #slot0.taskGroup, 1 do
		...
		if slot0.taskProxy:getTaskVO(slot9) then
			...
			slot19 = pg.task_data_template[slot9].desc

			setText(slot0:findTF("desc", slot8), string.gsub(string.gsub(slot19, "$1", (slot14 and pg.task_data_template[slot9].target_num) or 0), "$2", pg.task_data_template[slot9].target_num))
		...
		slot13.material = (slot2 and slot0.materialGray) or nil
