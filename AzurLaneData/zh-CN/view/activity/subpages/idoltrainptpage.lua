...
slot0.OnInit = function (slot0)
	...
	eachChild(slot0.skills, function (slot0)
		table.insert(slot0.skillBtns, slot0)
	end)
	...
	slot0.info = slot0.findTF(slot0, "panel/info", slot0.trainWindow)
...
slot0.OnFirstFlush = function (slot0)
	...
	for slot4, slot5 in ipairs(slot0.skillBtns) do
		onButton(slot0, slot5, function ()
			for slot3, slot4 in ipairs(slot0.ptData:GetCurBuffInfos()) do
				if slot1 == slot4.group then
					slot0:showBuffInfoBox(slot4)
				end
			end
		end, SFX_PANEL)
	end

	slot5, slot5 = slot0.getRandomName(slot0)
...
slot0.OnUpdateFlush = function (slot0)
	...
	slot12, slot11, slot4 = slot0.ptData:GetLevelProgress()
...
slot0.flushTrainPanel = function (slot0)
	if slot0.ptData:GetCurBuffInfos() then
		for slot5, slot6 in ipairs(slot1) do
			...
			setImageSprite(slot0:findTF("icon", slot0.trainSkillBtns[slot6.group]), LoadSprite(slot7))
...
slot0.showBuffInfoBox = function (slot0, slot1)
	...
	setImageSprite(slot0.titleIcon, LoadSprite(slot3))
	updateDrop(slot0.buffAwardTF, slot4)
	...
	if slot1.next then
		...
		setActive(slot0.findTF(slot0, "icon_bg/got_mask", slot0.buffAwardTF), false)
	else
...
slot0.showMsgBox = function (slot0)
	if slot0.selectBuffId then
		...
		setImageSprite(slot0.msgIcon, LoadSprite(slot1))
		setText(slot0.msgContent, i18n("practise_idol_tip", slot2))
		...
		onButton(slot0, slot0.confirmBtn, function ()
			...
			slot0.hideMsgBox.emit.hideTrianPanel:showTip(i18n("upgrade_complete_tip"))
		end, SFX_PANEL)
	end
end
