...
slot0.OnFirstFlush = function (slot0)
	...
	pg.SystemGuideMgr.GetInstance():PlayByGuideId(slot0.activity.getConfig(slot3, "config_client").guideName)
end
...
slot0.OnUpdateFlush = function (slot0)
	...
	for slot9, slot10 in ipairs(slot0.items) do
		...
		slot0.loader.GetSprite(slot13, "UI/ActivityUIPage/AprilFoolDiscoveryPage_atlas", slot1[(table.contains(slot4, slot0.keyList[slot9]) and 3) or (table.contains(slot5, slot11) and 2) or 1], slot10:Find("state"))
