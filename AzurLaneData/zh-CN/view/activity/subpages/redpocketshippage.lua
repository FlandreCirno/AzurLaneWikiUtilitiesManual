...
slot0.OnFirstFlush = function (slot0)
	...
	slot5 = {
		type = slot0.activity.getConfig(slot1, "config_client")[1][1],
		id = slot0.activity.getConfig(slot1, "config_client")[1][2],
		count = slot0.activity.getConfig(slot1, "config_client")[1][3]
	}
