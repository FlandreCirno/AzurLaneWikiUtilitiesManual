...
slot0.OnFirstFlush = function (slot0)
	...
	slot0.step = slot0.findTF(slot0, "AD/switcher/phase2/Image/step")
...
slot0.Switch = function (slot0, slot1)
	...
	setLocalPosition(go(slot0.phases[1]), slot4)
	...
	setLocalPosition(go(slot0.phases[2]), slot3)
...
slot0.UpdateAwardGot = function (slot0)
	...
	setActive(slot0.step, not (not slot0.ptData.CanGetNextAward() and slot0.inPhase2))
	setActive(slot0.progress, not (not slot0.ptData.CanGetNextAward() and slot0.inPhase2))
end
