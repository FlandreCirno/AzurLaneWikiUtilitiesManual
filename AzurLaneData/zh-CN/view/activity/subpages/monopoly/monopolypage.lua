...
slot0.OnInit = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_MOVE, function (slot0, slot1, slot2)
		pg.m02:sendNotification(GAME.MONOPOLY_OP, {
			activity_id = slot1,
	...
	slot0.bind(slot0, slot0.ON_TRIGGER, function (slot0, slot1, slot2)
		pg.m02:sendNotification(GAME.MONOPOLY_OP, {
			activity_id = slot1,
	...
	slot0.bind(slot0, slot0.ON_AWARD, function (slot0)
