...
slot0.OnInit = function (slot0)
	...
	slot0.bind(slot0, Monopoly3thPage.ON_START, function (slot0, slot1, slot2)
		pg.m02:sendNotification(GAME.MONOPOLY_OP, {
			activity_id = slot1,
	...
	slot0.bind(slot0, Monopoly3thPage.ON_MOVE, function (slot0, slot1, slot2)
		pg.m02:sendNotification(GAME.MONOPOLY_OP, {
			activity_id = slot1,
	...
	slot0.bind(slot0, Monopoly3thPage.ON_TRIGGER, function (slot0, slot1, slot2)
		pg.m02:sendNotification(GAME.MONOPOLY_OP, {
			activity_id = slot1,
	...
	slot0.bind(slot0, Monopoly3thPage.ON_AWARD, function (slot0)
		slot0:emit(ActivityMediator.EVENT_GO_SCENE, SCENE.REDPACKEY)
	end)
end

slot0.getLeftRpCount = function ()
	return getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_MONOPOLY).data2_list[1] - getProxy(ActivityProxy).getActivityByType(ActivityConst.ACTIVITY_TYPE_MONOPOLY).data2_list[2]
end
