...
slot0.initBtnList = function (slot0, slot1)
	...
	onButton(slot0, slot1[3], function ()
		slot0:emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.ACTIVITY_TYPE_RETURN_AWARD_ID3)
	end, SFX_PANEL)
	...
	onButton(slot0, slot1[6], function ()
		slot0:emit(ActivityMediator.SELECT_ACTIVITY, ActivityConst.PIZZAHUT_PT_PAGE)
	end, SFX_PANEL)
