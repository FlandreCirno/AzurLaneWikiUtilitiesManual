...
slot0.OnInit = function (slot0)
	...
	slot0.puzzle = slot0.findTF(slot0, "Puzzle", slot0.bg)
...
slot0.OnUpdateFlush = function (slot0)
	...
	for slot5 = 1, #slot0.puzzleIDList, 1 do
		...
		slot0:updatePiece((table.contains(slot1.data1_list, slot0.puzzleIDList[slot5]) or 0) and 1, slot0.puzzle:GetChild(slot5 - 1))
	...
	slot2 = nil
	slot2 = (#slot0.chargeIDList == #slot0.taskGroup and "<color=#00FF00><size=48>" .. #slot0.chargeIDList .. "</size></color><color=#00B8FF><size=28>     " .. #slot0.taskGroup .. "</size></color>") or "<color=#E75198><size=48>" .. #slot0.chargeIDList .. "</size></color><color=#00B8FF><size=28>     " .. #slot0.taskGroup .. "</size></color>"

	setText(slot0.dayTF, slot2)
end
