...
slot0.register = function (slot0)
	slot0:bind(slot0.START_SELECT, function (slot0, slot1)
		slot0:sendNotification(GAME.ACTIVITY_PERMANENT_START, {
			activity_id = slot1
		})
	end)
	slot0.viewComponent.setActivitys(slot1, Clone(pg.activity_task_permanent.all))
end
