...
slot0.didEnter = function (slot0)
	...
	slot0.InitFacility(slot0, slot0.shrine, function ()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, 3)
	end)
	slot0.InitFacility(slot0, slot0.snack_street, function ()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, 2)
	end)
	slot0.InitFacility(slot0, slot0.entertainment_street, function ()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, 5)
	end)
	slot0.InitFacility(slot0, slot0.firework_factory, function ()
