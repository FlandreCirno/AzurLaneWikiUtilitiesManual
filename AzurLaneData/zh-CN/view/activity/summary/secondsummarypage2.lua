class("SecondSummaryPage2", import(".SummaryAnimationPage")).OnInit = function (slot0)
	setPaintingPrefabAsync(slot0._tf:Find("paint_panel/painting"), slot1, "chuanwu")
...
return class("SecondSummaryPage2", import(".SummaryAnimationPage"))
