...
slot0.didEnter = function (slot0)
	...
	slot0:InitStudents(getProxy(ActivityProxy).getActivityById(slot1, ActivityConst.NEWYEAR_SNACKSTREET_MINIGAME) and slot1.id, 3, 4)
	slot0:InitFacilityCross(slot0._map, slot0._upper, "daxuezhang", function ()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, 18)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "xiaochijie", function ()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, 19)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "qiaozhong", function ()
		pg.m02:sendNotification(GAME.GO_MINI_GAME, 20)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "fuzhuangdian", function ()
		slot0:emit(NewYearFestivalMediator.GO_SCENE, SCENE.SKINSHOP)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "mofang", function ()
...
slot0.UpdateView = function (slot0)
	setActive(slot0.upper_daxuezhang:Find("Tip"), slot0.IsMiniActNeedTip(ActivityConst.NEWYEAR_SNOWBALL_FIGHT))
