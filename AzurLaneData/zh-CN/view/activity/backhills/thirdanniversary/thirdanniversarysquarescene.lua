...
slot0.RegisterDataResponse = function (slot0)
	...
	for slot5, slot6 in ipairs(slot1) do
		slot0.Respones:AddRawListener({
			...
			slot0.loader:GetSprite("ui/thirdanniversarysquareui_atlas", slot0 .. slot1, slot0["map_" .. slot0])
...
slot0.didEnter = function (slot0)
	...
	onButton(slot0, slot0.top:Find("daka_count"), function ()
		slot0:emit(ThirdAnniversarySquareMediator.ON_OPEN_TOWERCLIMBING_SIGNED)
	end)
	...
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "nvpukafeiting", function ()
		slot0.upgradePanel:Set(slot0.activity, 1)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "xiaolongbaodian", function ()
		slot0.upgradePanel:Set(slot0.activity, 2)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "zhajihanbaodian", function ()
		slot0.upgradePanel:Set(slot0.activity, 3)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "heguozidian", function ()
		slot0.upgradePanel:Set(slot0.activity, 4)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "gangqvchenlieshi", function ()
...
slot0.UpdateView = function (slot0)
	...
	slot0.Respones.gangqvchenlieshiTip = getProxy(MiniGameProxy).GetHubByHubId(slot6, getProxy(ActivityProxy).getActivityByType(slot3, ActivityConst.ACTIVITY_TYPE_MINIGAME).getConfig(slot5, "config_id")).count > 0
