...
slot0.init = function (slot0)
	...
	end), Color(0, 0, 0, 0), Color(1, 1, 0, 0), 1.5).setLoopPingPong(slot1, -1)
end
...
slot0.didEnter = function (slot0)
	...
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "kaihongbao", function ()
	...
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "danianshou", function ()
		slot0:emit(NewYearFestivalMediator.GO_SCENE, SCENE.ACTIVITY, {
			id = ActivityConst.BEAT_MONSTER_NIAN_2020
		})
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "dafuweng", function ()
		slot0:emit(NewYearFestivalMediator.GO_SCENE, SCENE.ACTIVITY, {
			id = ActivityConst.MONOPOLY_2020
		})
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "diediele", function ()
	...
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "sishu", function ()
		slot0:emit(NewYearFestivalMediator.GO_SCENE, SCENE.COLORING)
	end)
	slot0.InitFacilityCross(slot0, slot0._map, slot0._upper, "pifushangdian", function ()
...
slot0.UpdateView = function (slot0)
	setActive(slot0._upper:Find("danianshou/tip"), getProxy(ActivityProxy).getActivityById(slot3, ActivityConst.BEAT_MONSTER_NIAN_2020) and slot2.readyToAchieve(nil))
	setActive(slot0._upper:Find("dafuweng/tip"), slot3:getActivityById(ActivityConst.MONOPOLY_2020) and slot2:readyToAchieve())
	setActive(nil, getProxy(ColoringProxy):CheckTodayTip())
