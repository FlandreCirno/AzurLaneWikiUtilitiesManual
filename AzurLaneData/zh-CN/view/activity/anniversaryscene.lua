...
slot0.initScrollRect = function (slot0)
	...
	slot0.moveToTaskGroup(slot0, slot0.dateIndex, true)
...
slot0.updateBottomTaskGroup = function (slot0, slot1)
	...
	triggerToggle(slot2, _.all(slot5, function (slot0)
...
slot0.updateTaskGroup = function (slot0, slot1, slot2, slot3)
	...
	if slot7 then
		...
		slot10 = _.all(slot3, function (slot0)
			return slot0:getTaskById(slot0) and slot1:isReceive()
		end)
		slot8 = slot10
	end
...
slot0.updateTaskGroupDesc = function (slot0, slot1)
	...
	function slot8(slot0, slot1)
		...
		setActive(slot0.Find(slot0, "confirm_btn/go"), not slot0.getTaskById(slot1) or Task.New():isFinish())
		...
		slot0.findTF(slot6, "slider", slot0):GetComponent(typeof(Slider)).value = slot0.getTaskById(slot1) or Task.New():getProgress() / slot0.getTaskById(slot1) or Task.New():getConfig("target_num")
	...
	slot0.ulist = UIItemList.New(slot6, slot7)
	...
	slot0.ulist.align(slot9, #slot0.configData[slot1])
end
