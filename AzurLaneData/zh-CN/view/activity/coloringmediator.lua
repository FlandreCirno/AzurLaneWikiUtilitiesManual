...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.EVENT_COLORING_CELL, function (slot0, slot1)
		slot0:sendNotification(GAME.COLORING_CELL, slot1)
	end)
	slot0.bind(slot0, slot0.EVENT_COLORING_CLEAR, function (slot0, slot1)
...
slot0.handleNotification = function (slot0, slot1)
	...
	if slot1:getName() == GAME.COLORING_CELL_DONE then
		...
		slot0.viewComponent.updateSelectedColoring(slot4)
