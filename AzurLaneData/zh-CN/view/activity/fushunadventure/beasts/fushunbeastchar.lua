...
slot0.MakeHpBar = function (slot0)
	...
	slot0.hpBar:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			setActive(slot2:Find("mark"), slot1 < slot0.hp)
		end
	end)
	slot0.hpBar.align(slot1, slot0.maxHp)
end
...
slot0.Attack = function (slot0)
	...
	slot0.animatorEvent.SetTriggerEvent(slot1, nil)
	...
	slot0.animator.SetTrigger(slot1, "attack")
end
...
slot0.Vanish = function (slot0)
	...
	if slot0:IsEscape() then
		...
		slot0.animator.SetTrigger(slot1, "vanish")
	end
