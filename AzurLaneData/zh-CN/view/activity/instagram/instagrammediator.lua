...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_LIKE, function (slot0, slot1)
		slot0:sendNotification(GAME.ACT_INSTAGRAM_OP, {
			arg2 = 0,
	...
	slot0.bind(slot0, slot0.ON_SHARE, function (slot0, slot1)
		slot0:sendNotification(GAME.ACT_INSTAGRAM_OP, {
			arg2 = 0,
	...
	slot0.bind(slot0, slot0.ON_COMMENT, function (slot0, slot1, slot2, slot3)
		slot0:sendNotification(GAME.ACT_INSTAGRAM_OP, {
	...
	slot0.bind(slot0, slot0.ON_REPLY_UPDATE, function (slot0, slot1)
		slot0:sendNotification(GAME.ACT_INSTAGRAM_OP, {
			arg2 = 0,
	...
	slot0.bind(slot0, slot0.ON_COMMENT_LIST_UPDATE, function (slot0, slot1, slot2)
	...
	slot0.viewComponent.SetProxy(slot1, getProxy(InstagramProxy))
end
...
slot0.handleNotification = function (slot0, slot1)
	...
	if slot1:getName() == GAME.ACT_INSTAGRAM_OP_DONE then
		slot0.viewComponent.SetProxy(slot5, getProxy(InstagramProxy))
