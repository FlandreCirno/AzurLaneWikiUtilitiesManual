...
slot0.init = function (slot0)
	...
	slot0.teacher = slot0.findTF(slot0, "scene/teacher")
...
slot0.didEnter = function (slot0)
	...
	onButton(slot0, slot0.btnStart, function ()
		...
		elseif #slot0.students == 0 then
			pg.TipsMgr.GetInstance().ShowTips(slot1, i18n("course_class_not_ready"))
		elseif slot0.proficiency == 0 then
			...
			if _.any(slot0.students, function (slot0)
				...
				pg.TipsMgr.GetInstance().ShowTips(slot3, i18n("course_student_max_level"))
...
slot0.updateMainView = function (slot0)
	...
	GetImageSpriteFromAtlasAsync(slot1.getConfig(slot1, "icon"), "", slot0.teacher:Find("pop/icon"))
...
slot0.updateEffect = function (slot0)
	...
	if math.random(0, 20) <= 1 and slot0.desks[math.floor(math.random(1, 6))] and isActive(slot7.Find(slot7, "ship")) and not isActive(slot7:Find("chat")) then
...
slot0.willExit = function (slot0)
	...
	if slot0.resTimer then
		pg.TimeMgr.GetInstance().RemoveTimer(slot1, slot0.resTimer)
