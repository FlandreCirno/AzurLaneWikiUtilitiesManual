...
slot0.register = function (slot0)
	...
	slot0.viewComponent:setResClass(slot3)
	...
	slot0.bind(slot0, slot0.CLASS_START_COURSE, function (slot0, slot1)
		slot0:sendNotification(GAME.CLASS_START_COURSE, {
			students = slot1
		})
	end)
	slot0.bind(slot0, slot0.CLASS_STOP_COURSE, function (slot0)
		slot0:sendNotification(GAME.CLASS_STOP_COURSE)
	end)
	slot0.bind(slot0, slot0.CLASS_UPGRADE, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.CLASS_UPGRADE_TIMES_UP, function (slot0)
		getProxy(NavalAcademyProxy).UpgradeFinish(slot1)
		slot0:updateResourcePanel()
		slot0:updateClassView()
	end)
	slot0.bind(slot0, slot0.CLASS_CLEAR_STUDENT, function (slot0)
		slot1 = getProxy(NavalAcademyProxy)
