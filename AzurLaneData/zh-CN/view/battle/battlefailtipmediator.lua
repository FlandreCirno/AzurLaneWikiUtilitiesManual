...
slot0.bindEvent = function (slot0)
	...
	slot0.bind(slot0, slot0.GO_HIGEST_CHAPTER, function (slot0)
		slot0:removeContextBeforeGO()

		slot8.targetChapter, slot8.targetMap = getProxy(ChapterProxy).getHigestClearChapterAndMap(slot1)

		slot0:sendNotification(GAME.CHANGE_SCENE, SCENE.LEVEL, {
			targetChapter = slot2,
			targetMap = slot3
		})
	end)
	slot0.bind(slot0, slot0.GO_DOCKYARD_EQUIP, function (slot0)
		slot0:removeContextBeforeGO()
	...
	slot0.bind(slot0, slot0.GO_DOCKYARD_SHIP, function (slot0)
		slot0:removeContextBeforeGO()
	...
	slot0.bind(slot0, slot0.GO_NAVALTACTICS, function (slot0)
		slot0:removeContextBeforeGO()
