...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.OPEN_RIVAL_INFO, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.OPEN_DOCKYARD, function (slot0, slot1, slot2)
	...
	slot0.bind(slot0, slot0.REPLACE_RIVALS, function (slot0)
