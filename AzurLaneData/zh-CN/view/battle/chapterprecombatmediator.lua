...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_SWITCH_SHIP, function (slot0, slot1)
		slot2 = getProxy(ChapterProxy)

		slot2:getActiveChapter().fleet:synchronousShipIndex(slot1)
		slot2:updateChapter(slot2.getActiveChapter(), ChapterConst.DirtyFleet)
	end)
