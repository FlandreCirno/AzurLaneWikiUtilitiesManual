...
slot0.Ctor = function (slot0, slot1, slot2)
	...
	onButton(slot0.parent, slot0._tf.Find(slot6, "frame/bg/close_btn"), function ()
		slot0:Hide()
	end, SFX_PANEL)
	...
	slot0.sprites = {
		slot0._tf.Find(slot5, "frame/bg/content/list/1/icon/iconImg"):GetComponent(typeof(Image)).sprite,
...
slot0.Show = function (slot0, slot1, slot2)
	...
	slot0.buildPoolList.make(slot4, function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			pressPersistTrigger(slot2.Find(slot2, "icon"), 0.5, slot4, nil, true, true, 0.15, SFX_PANEL)
	...
	slot0.buildPoolList.align(slot4, #slot3)
	slot0:UpdatePos()
...
slot0.UpdatePos = function (slot0)
	function slot1(slot0, slot1)
		...
		if slot0.selected[slot0] then
			...
			setText(slot1.Find(slot1, "empty/Text"), slot0)
		end
	...
	slot0.posListTop.make(slot2, function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			slot0(slot1 + 1, slot2)
		end
	end)
	slot0.posListTop.align(slot2, math.min(5, slot0))
	slot0.posListBottom:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			slot0(slot1 + 6, slot2)
		end
	end)
	slot0.posListBottom.align(slot2, math.max(0, math.min(5, slot0 - 5)))
