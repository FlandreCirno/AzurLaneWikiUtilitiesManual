...
slot0.Update = function (slot0, slot1)
	...
	elseif slot2 == CommanderBox.STATE_WAITING then
		slot3 = slot1.beginTime - pg.TimeMgr.GetInstance():GetServerTime()
	...
	elseif slot2 == CommanderBox.STATE_STARTING then
		...
		onButton(slot0._parent, slot0.quicklyTool, function ()
			slot0._parent:emit(CommandRoomScene.ON_QUICKLY_TOOL_WINDOW, slot1.id)
		end, SFX_PANEL)
	...
	slot0:loadBox(slot1.getPrefab(slot1), slot0.boxParent)
end
