...
slot0.UpdateStyle = function (slot0)
	if not (slot0.cattery.GetState(slot1) == Cattery.STATE_LOCK) then
...
slot0.FlushCommander = function (slot0)
	...
	slot2 = slot0.cattery.GetCommander(slot1)
...
slot0.InitBubble = function (slot0)
	...
	setActive(slot0.feed, slot3)
	setActive(slot0.play, slot0.cattery.ExistPlayOP(slot1))
	setActive(slot0.bubble, slot0.cattery.ExistCleanOP(slot1) or slot3 or slot4)
end
...
slot0.AddExpAnim = function (slot0, slot1, slot2)
	...
	slot0.timer = Timer.New(function ()
		slot0:RemoveTimer()
		setActive(slot0.expAddition, false)
		slot0.expAddition()
	end, 1, 1)
