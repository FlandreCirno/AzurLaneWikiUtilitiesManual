...
slot0.UpdateCommander = function (slot0)
	slot0.super.UpdateCommander(slot0)
...
slot0.Action = function (slot0, slot1)
	...
	table.insert(slot2, function (slot0)
		slot0:AdditionAnim(slot0.AdditionAnim, slot0)
	end)
...
slot0.AdditionAnim = function (slot0, slot1, slot2)
	...
	LeanTween.value(go(slot0.addition), slot3, slot0.additionY + 25, slot1):setOnUpdate(System.Action_float(function (slot0)
		...
		slot1.addition.localPosition = Vector3(slot0.addition.localPosition.x, , 0)
	end))
end
