...
slot0.register = function (slot0)
	...
	slot0:bind(slot0.ON_OPEN_SCENE, function (slot0)
		slot0:sendNotification(GAME.OPEN_OR_CLOSE_CATTERY, {
			open = true
		})
	end)
	slot0.bind(slot0, slot0.ON_USE_QUICKLY_TOOL, function (slot0, slot1, slot2, slot3)
	...
	slot0.bind(slot0, slot0.ON_OPEN_HOME, function (slot0)
	...
	slot0.bind(slot0, slot0.OPEN_RENAME_PANEL, function (slot0, slot1)
		slot0.viewComponent:opeRenamePanel(slot1)
	end)
	slot0.bind(slot0, slot0.SHOW_MSGBOX, function (slot0, slot1)
		slot0.viewComponent:openMsgBox(slot1)
	end)
	slot0.bind(slot0, slot0.ON_TREE_MSGBOX, function (slot0, slot1)
	...
	slot0.bind(slot0, slot0.ON_REMARK, function ()
		slot0.viewComponent:setCommanders(slot0:markFleet())
	end)
	slot0.bind(slot0, slot0.ON_RESERVE_BOX, function (slot0, slot1, slot2)
		slot0:sendNotification(GAME.COMMANDER_RESERVE_BOX, {
			count = slot1
		})
	end)
	slot0.bind(slot0, slot0.ON_GET, function (slot0, slot1, slot2)
		slot0:sendNotification(GAME.COMMANDER_ON_OPEN_BOX, {
			id = slot1,
			callback = slot2
		})
	end)
	slot0.bind(slot0, slot0.ON_BATCH_GET, function (slot0, slot1)
		slot2 = {}
	...
	slot0.bind(slot0, slot0.ON_BATCH_BUILD, function (slot0, slot1)
		slot2 = {}
	...
	slot0.bind(slot0, slot0.ON_DETAIL, function (slot0, slot1, slot2)
		slot3 = {}
	...
	slot0.bind(slot0, slot0.ON_FETCH, function (slot0, slot1)
	...
	slot0.viewComponent.setPlayer(slot4, getProxy(PlayerProxy).getData(slot1))
...
slot0.markFleet = function (slot0)
	...
	elseif CommandRoomScene.FLEET_TYPE_HARD_CHAPTER == slot0.contextData.fleetType then
		for slot9, slot10 in pairs(getProxy(ChapterProxy).getChapterById(slot4, slot0.contextData.chapterId).getEliteFleetCommanders(slot5)) do
...
slot0.handleNotification = function (slot0, slot1)
	...
	elseif slot2 == CommanderProxy.RESERVE_CNT_UPDATED then
		slot0.viewComponent.setReserveBoxCnt(slot4, slot3)
	...
	elseif slot2 == GAME.COMMANDER_ON_BATCH_DONE then
		...
		if slot0.viewComponent.boxesPanel then
			...
			pg.UIMgr.GetInstance().LoadingOn(slot7, false)
