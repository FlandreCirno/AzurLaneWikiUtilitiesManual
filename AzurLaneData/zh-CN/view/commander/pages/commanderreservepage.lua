...
slot0.OnInit = function (slot0)
	...
	setText(slot0._tf.Find(slot2, "frame/bg1/tip"), i18n("commander_build_rate_tip"))
end
		...
		slot0.aniEvt:SetTriggerEvent(function (slot0)
			...
			for slot4, slot5 in ipairs(slot0) do
				for slot9 = 1, slot5.count, 1 do
					slot10 = LeanTween.delayedCall(0.2 + 1 * slot2 + 1 * (slot9 - 1), System.Action(function ()
						slot0:playBoxMove(slot0)
					end)).uniqueId

					table.insert(slot3.tweenList, slot10)
				end
