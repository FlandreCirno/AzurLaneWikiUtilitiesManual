...
slot0.initSort = function (slot0)
	...
	for slot4, slot5 in ipairs(slot0.sort) do
		...
		setText(slot6.Find(slot6, "Text"), slot5[1])
...
slot0.initNation = function (slot0)
	...
	for slot4, slot5 in pairs(slot0.nation) do
		slot6 = cloneTplTo(slot0.nationAllBtn, slot0.nationPanel.Find(slot8, "content"))
		...
		setText(slot6.Find(slot6, "Text"), Nation.Nation2Name(slot5))
...
slot0.initRarity = function (slot0)
	...
	for slot4, slot5 in pairs(slot0.rarity) do
		slot6 = cloneTplTo(slot0.rarityAllBtn, slot0.rarityPanel.Find(slot8, "content"))
