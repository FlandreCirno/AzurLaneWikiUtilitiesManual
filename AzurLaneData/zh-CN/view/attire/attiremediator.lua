...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_UNLOCK, function (slot0, slot1, slot2)
		slot0:sendNotification(GAME.GET_ATTIRE, {
			id = slot2,
			type = slot1
		})
	end)
	slot0.bind(slot0, slot0.ON_CHANGE_MEDAL_DISPLAY, function (slot0, slot1)
		slot0:sendNotification(GAME.CHANGE_PLAYER_MEDAL_DISPLAY, {
			medalList = slot1
		})
	end)
	slot0.viewComponent.setAttires(slot2, getProxy(AttireProxy).getDataAndTrophys(slot1, true))
