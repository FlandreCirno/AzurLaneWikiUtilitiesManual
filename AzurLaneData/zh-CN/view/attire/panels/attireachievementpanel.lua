...
slot0.OnInit = function (slot0)
	...
	slot0.confirmBtn = slot0.findTF(slot0, "list_panel/confirm")
	...
	onButton(slot0, slot0.confirmBtn, function ()
		...
		slot0.event.emit(slot0, AttireMediator.ON_CHANGE_MEDAL_DISPLAY, slot0.contextData.selectedMedalList)
	end, SFX_PANEL)

	slot0.descPanel = slot0(slot0.findTF(slot0, "desc_panel"))
...
slot0.Filter = function (slot0)
	...
	for slot5, slot6 in pairs(slot0.trophys) do
		if slot6.isClaimed(slot6) and not slot6:isHide() and (not slot0.selectMaxLevel or (slot0.selectMaxLevel and not slot1(slot6))) then
