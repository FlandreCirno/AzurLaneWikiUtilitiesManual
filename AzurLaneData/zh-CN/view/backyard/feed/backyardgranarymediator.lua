...
slot0.register = function (slot0)
	...
	slot0.viewComponent.setIsRemind(slot2, getProxy(SettingsProxy).getBackyardRemind(slot1))
	...
	slot0.bind(slot0, slot0.EXTEND_GRANARY, function (slot0, slot1, slot2)
		slot0:sendNotification(GAME.SHOPPING, {
			id = slot1,
			count = slot2
		})
	...
	slot0.viewComponent.setTrainShipVOs(slot2, slot0.dormProxy:getShipsByState(5))
