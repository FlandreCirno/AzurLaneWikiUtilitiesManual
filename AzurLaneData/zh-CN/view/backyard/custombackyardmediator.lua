...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, BackyardMainMediator.ADD_BOAT_MOVE, function (slot0, slot1)
		slot0:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
			name = BACKYARD.ADD_BOAT_MOVE,
			id = slot1
		})
	end)
	slot0.bind(slot0, BackyardMainMediator.CANCEL_SHIP_MOVE, function (slot0, slot1)
		slot0:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
			name = BACKYARD.CANCEL_BOAT_MOVE,
			id = slot1
		})
	end)
	slot0.bind(slot0, BackyardMainMediator.INTERACTION, function (slot0, slot1, slot2)
		slot0:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, BackyardMainMediator.INTERACTION_SPINE, function (slot0, slot1, slot2)
		slot0:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
	...
	slot0.bind(slot0, BackyardMainMediator.CLEAR_SPINE, function (slot0, slot1)
		slot0:sendNotification(BACKYARD.COMMAND_BACKYARD_BOAT, {
