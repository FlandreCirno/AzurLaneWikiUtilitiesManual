...
slot0.didEnter = function (slot0)
	...
	slot0.controller.SetCallback(slot4, slot1, slot2, function ()
...
slot0.GetPtActivity = function (slot0)
...
slot0.PackData = function (slot0)
	...
	for slot14 = 1, math.min(slot3, math.floor(slot0:GetPtActivity().data1 / 200)) - slot0.GetMGHubData(slot0).count, 1 do
