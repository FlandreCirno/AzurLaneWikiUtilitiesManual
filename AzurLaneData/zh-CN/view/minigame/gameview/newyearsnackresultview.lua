...
slot0.updateView = function (slot0)
	...
	slot0.orderList:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			setImageSprite(slot0:findTF("SnackImg", slot2), GetSpriteFromAtlas("ui/newyearsnackui_atlas", "snack_" .. slot3, true))
		end
	end)
	slot0.orderList.align(slot2, #slot0.contextData.orderIDList)
	slot0.selectedList:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			setImageSprite(slot4, GetSpriteFromAtlas("ui/newyearsnackui_atlas", "snack_" .. slot3, true))
	...
	slot0.selectedList.align(slot2, #slot0.contextData.selectedIDList)
