...
slot0.initData = function (slot0)
	...
	slot0.shrineBuffView = NewYearShrineBuffView.New(slot0._tf.parent, slot0.event, slot3)
...
slot0.findUI = function (slot0)
	...
	slot0.clockBtn = slot0:findTF("ClockBtn", slot0:findTF("Main"))
...
slot0.addListener = function (slot0)
	...
	slot0.buffDftAniEvent.SetEndEvent(slot1, function ()
		setButtonEnabled(slot0.clockBtn, true)
	end)
end
...
slot0.playAnime = function (slot0, slot1, slot2)
	...
	slot0.clockDftAniEvent:SetEndEvent(function ()
		...
		if setButtonEnabled.clockSE then
			slot0.clockSE:Stop(true)
		end

		slot0.shrineResultView:Reset()
		slot0.shrineResultView.Reset.shrineResultView:Load()
		slot0.shrineResultView.Reset.shrineResultView.Load.shrineResultView:ActionInvoke("updateView", slot0.shrineResultView.Reset.shrineResultView.Load.shrineResultView, )
		slot0.shrineResultView.Reset.shrineResultView.Load.shrineResultView.ActionInvoke.shrineResultView:ActionInvoke("setCloseFunc", function ()
			if slot0 then
				slot1:updateBuff(slot1.updateBuff)
	...
	slot0.clockEffectAni.Play(slot3, "ClockAni", -1, 0)
end
