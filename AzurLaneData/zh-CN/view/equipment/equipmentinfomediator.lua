...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_EQUIP, function (slot0)
		if slot0.contextData.oldShipId then
			slot3, slot4 = ShipStatus.ShipStatusCheck("onModify", getProxy(BayProxy).getShipById(slot1, slot0.contextData.oldShipId))
	...
	slot0.bind(slot0, slot0.ON_UNEQUIP, function (slot0)
	...
	slot0.bind(slot0, slot0.ON_INTENSIFY, function (slot0)
	...
	slot0.bind(slot0, slot0.ON_CHANGE, function (slot0)
		slot1 = getProxy(BayProxy)
		slot5 = slot1:getEquipsInShips(slot2, slot0.contextData.pos)
		...
		slot0.viewComponent.emit(slot6, BaseUI.ON_CLOSE)
	...
	slot0.bind(slot0, slot0.ON_REVERT, function (slot0, slot1)
		slot0:sendNotification(GAME.REVERT_EQUIPMENT, {
			id = slot1
		})
	end)
	slot0.bind(slot0, slot0.ON_MOVE, function (slot0, slot1)
		slot0.viewComponent:emit(BaseUI.ON_CLOSE)
	...
	slot0.bind(slot0, slot0.OPEN_LAYER, function (slot0, ...)
		slot0:addSubLayers(...)
	end)

	if slot0.contextData.equipment then
		slot0.viewComponent.setEquipment(slot4, slot0.contextData.equipment)
	else
	...
	slot0.viewComponent:setShip(getProxy(BayProxy).getShipById(slot4, slot0.contextData.shipId), (slot0.contextData.oldShipId and slot4:getShipById(slot0.contextData.oldShipId)) or nil)
	slot0.viewComponent:setPlayer(getProxy(PlayerProxy).getData(slot7))
end
