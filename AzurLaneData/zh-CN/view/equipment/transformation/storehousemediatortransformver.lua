...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_USE_ITEM, function (slot0, slot1, slot2, slot3)
	...
	slot0.bind(slot0, slot0.ON_DESTROY, function (slot0, slot1)
		slot0:sendNotification(GAME.DESTROY_EQUIPMENTS, {
			equipments = slot1
		})
	end)
	slot0.bind(slot0, slot0.ON_UNEQUIP_EQUIPMENT, function (slot0)
		slot0:sendNotification(GAME.UNEQUIP_FROM_SHIP, {
			shipId = slot0.contextData.shipId,
			pos = slot0.contextData.pos
		})
	end)
	slot0.bind(slot0, slot0.OPEN_DESIGN, function (slot0)
	...
	slot0.bind(slot0, slot0.CLOSE_DESIGN_LAYER, function (slot0)
		if getProxy(ContextProxy).getContextByMediator(slot1, EquipmentMediator):getContextByMediator(EquipmentDesignMediator) then
	...
	slot0.bind(slot0, slot0.ON_EQUIPMENT_SKIN_INFO, function (slot0, slot1, slot2, slot3)
		slot0:addSubLayers(Context.New({
	...
	slot0.bind(slot0, slot0.ON_UNEQUIP_EQUIPMENT_SKIN, function (slot0)
	...
	slot0.bind(slot0, slot0.OPEN_EQUIPSKIN_INDEX_LAYER, function (slot0, slot1)
		slot0:addSubLayers(Context.New({
	...
	slot0.viewComponent.OnMediatorRegister(slot1)
...
slot0.handleNotification = function (slot0, slot1)
	...
	if slot1:getName() == slot0.NO_UPDATE then
