...
slot0.register = function (slot0)
	...
	slot0.bind(slot0, slot0.ON_EQUIP_FORM_SHIP, function (slot0)
		if not slot0.contextData.oldShipInfo then
			return
		end

		slot2, slot3 = ShipStatus.ShipStatusCheck("onModify", getProxy(BayProxy):getShipById(slot0.contextData.oldShipInfo.id))
	...
	slot0.bind(slot0, slot0.ON_PREVIEW, function (slot0, slot1)
		slot4 = {}
