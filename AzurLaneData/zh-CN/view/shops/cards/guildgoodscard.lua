...
slot0.Init = function (slot0)
	...
	setImageSprite(slot0.itemIconBgTF, GetSpriteFromAtlas("weaponframes", "bg" .. ItemRarity.Rarity2Print(slot0.goods:getConfig("goods_rarity") or 1)))
	setImageColor(slot0.itemIconFrameTF, shipRarity2FrameColor(ItemRarity.Rarity2Print(slot0.goods.getConfig("goods_rarity") or 1) + 1))
end
