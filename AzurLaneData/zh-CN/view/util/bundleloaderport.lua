...
slot0.LoadPrefab = function (slot0, slot1, slot2, slot3, slot4)
	...
	slot0.getAssetAsync(slot6, slot1, slot2, UnityEngine.Events.UnityAction_UnityEngine_Object(function (slot0)
		if slot0 then
			return
		end

		Object.Instantiate(slot0)(Object.Instantiate(slot0))
	end), true, false)
end
...
slot0.LoadSprite = function (slot0, slot1, slot2, slot3, slot4)
	...
	slot0.getAssetAsync(slot8, slot1, slot2, typeof(Sprite), UnityEngine.Events.UnityAction_UnityEngine_Object(function (slot0)
		if slot0 then
			return
		end
