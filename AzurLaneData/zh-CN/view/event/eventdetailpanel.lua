...
slot0.Flush = function (slot0)
	...
	SetActive(slot0.disabeleBtn, not slot0.event.reachLevel(slot1) or not slot2 or not slot3)

	slot4 = slot0.event.ships

	setScrollText(slot0.condition1, not slot0.event.reachLevel(slot1) or not slot2 or not slot3)
