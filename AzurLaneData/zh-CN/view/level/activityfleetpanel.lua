...
slot0.updateFleet = function (slot0, slot1, slot2)
	...
	if slot4 then
		...
		onButton(slot0, slot11, function ()
			slot0.parent:emit(slot1.ON_FLEET_RECOMMEND, slot2.id)
		end)
		onButton(slot0, slot12, function ()
			slot0.parent:emit(slot1.ON_FLEET_CLEAR, slot2.id)
		end, SFX_UI_CLICK)
	end
end
...
slot0.updateShips = function (slot0, slot1, slot2, slot3, slot4, slot5)
	...
	slot6:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			...
			function slot6()
				slot0.onCancel()
				slot0.onCancel.parent:emit(slot1.ON_OPEN_DOCK, {
					shipType = 0,
					fleet = slot2,
					shipVO = slot3,
					fleetIndex = slot3,
			...
			slot5.onReleased.RemoveAllListeners(slot7)
			slot5.onLongPressed:RemoveAllListeners()
			slot5.onReleased:AddListener(function ()
				slot0()
			end)
			slot5.onLongPressed.AddListener(slot7, function ()
				if slot0 then
					slot1.onCancel()
