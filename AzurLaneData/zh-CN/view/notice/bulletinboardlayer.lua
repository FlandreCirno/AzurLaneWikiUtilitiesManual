...
slot0.init = function (slot0)
	...
	slot0._scrollRect = slot0.findTF(slot0, "content_view"):GetComponent(typeof(ScrollRect))
...
slot0.didEnter = function (slot0)
	...
	triggerToggle(slot0._stopRemind, getProxy(ServerNoticeProxy).getStopRemind(slot1))
end
...
slot0.setNotices = function (slot0, slot1)
	...
	BulletinBoardMgr.Inst.ClearCache(slot4, slot2, slot3)
end
...
slot0.setNoticeDetail = function (slot0, slot1)
	...
	setText(slot0._detailContentTxt, slot2)
		...
		BulletinBoardMgr.Inst:GetSprite(slot1.id, slot1.version, slot7, UnityEngine.Events.UnityAction_UnityEngine_Sprite(function (slot0)
			...
			if slot0 ~= nil then
				...
				if slot0.loadingCount <= 0 then
					setText(slot0._detailContentTxt, SwitchSpecialChar(slot0.realContent, true))
				end
			end
		end))
	end
