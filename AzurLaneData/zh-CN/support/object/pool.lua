...
slot2.InitSizeAsync = function (slot0, slot1, slot2)
	slot2 = slot2 or slot0.min
	slot3 = 0
	slot0.initTimer = Timer.New(function ()
		slot0:Recycle(slot0:GetObject())

		if slot0 <= slot0.Recycle + 1 then
			slot0.initTimer:Stop()
