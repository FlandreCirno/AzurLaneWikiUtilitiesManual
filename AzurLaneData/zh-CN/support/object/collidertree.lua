...
pg.CldArea.Ctor = function (slot0, slot1, slot2, slot3)
	slot0.min = slot1
	slot0.max = slot2
...
pg.CldArea.AddNode = function (slot0, slot1)
	slot0.insert(slot0.nodes, slot1)

	slot1.area = slot0
end

pg.CldArea.InArea = function (slot0, slot1, slot2)
...
pg.CldArea.GetAreaIndex = function (slot0, slot1, slot2)
	if ((slot0.center.x > slot1.x or 0) and 2) ~= ((slot3.x > slot2.x or 0) and 2) then
		return 0
	end
