slot0 = {
	ModifyMesh = function ()
		return function (slot0, slot1)
			...
			for slot11 = 0, ReflectionHelp.RefCallMethod(typeof("UnityEngine.TextGenerator"), "GetLinesArray", slot3).Length - 1, 1 do
				slot12 = (slot7 > slot11 + 1 and slot0(slot5[slot11 + 1])) or utf8_len(slot2.text)
				slot13 = 0

				for slot17 = slot0(slot5[slot11]), slot12 - 1, 1 do
...
function slot2(slot0)
	...
	for slot6, slot7 in ipairs({
		...
		while slot9 do
			...
			if slot9 == slot8 and #slot2 > 0 then
				for slot15 = 0, #table.remove(slot2).str - 1, 1 do
					slot1[slot11.start + slot15] = 1
				end

				for slot15 = 0, #slot9 - 1, 1 do
...
function slot3(slot0, slot1, slot2, slot3)
	if slot3 < slot2 then
		...
		elseif slot0[slot3] == 1 then
			slot1[slot3] = slot0(slot0, slot1, slot2, slot3 + 1)
...
InjectByName("VerticalText", slot0)
