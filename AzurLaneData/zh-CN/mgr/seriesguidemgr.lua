...
pg.SeriesGuideMgr.start = function (slot0, slot1)
	if slot0:canPlay(slot1) then
		...
		slot0.doGuideStep(slot0, slot1, function (slot0, slot1)
...
pg.SeriesGuideMgr.doGuideStep = function (slot0, slot1, slot2)
	...
	slot4 = slot0.stepConfig.segment[slot0.getSegmentIndex(slot0)][1]
	slot5 = slot0.stepConfig.segment[slot0.getSegmentIndex(slot0)][2]
	slot6 = {
		function (slot0)
			slot0.guideMgr:play(slot0.guideMgr.play, slot2.code, slot0, function ()
				slot0:updateIndex(slot0)
			end)
			slot0.guideMgr.mask(slot1)
		end,
		function (slot0)
...
pg.SeriesGuideMgr.checkCondition = function (slot0, slot1)
	...
	elseif slot5[1] == slot1 then
		slot4, slot3 = slot2.condition.func(slot7)
...
pg.SeriesGuideMgr.compatibleOldPlayer = function (slot0)
	...
	if slot0.player.guideIndex ~= slot0 then
