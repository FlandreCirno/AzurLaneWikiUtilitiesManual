...
return {
	...
	CheckPretest = function ()
		return Application.isEditor or slot0.CheckPreAudit()
	end,
	...
	LinkSocial = function (slot0, slot1, slot2)
		...
		elseif slot0 == AIRI_PLATFORM_AMAZON then
			slot1:LinkSocial(Airisdk.LoginPlatform.AMAZON)
		end
	end,
	UnlinkSocial = function (slot0)
		...
		elseif slot0 == AIRI_PLATFORM_AMAZON then
			slot1:UnlinkSocial(Airisdk.LoginPlatform.AMAZON)
		end
	end,
	IsSocialLink = function (slot0)
		...
		elseif slot0 == AIRI_PLATFORM_AMAZON then
			return slot1:CheckPlatformLink(Airisdk.LoginPlatform.AMAZON)
		end
	...
	GetSocialName = function (slot0)
		...
		elseif slot0 == AIRI_PLATFORM_AMAZON then
			return slot0.loginRet.AMAZON_NAME
		end
