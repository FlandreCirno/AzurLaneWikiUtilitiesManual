...
return {
	...
	UserCenter = function ()
		...
		slot0:UserCenter(slot1, BundleWizard.Inst:GetGroupMgr("DEFAULT_RES").CurrentVersion:ToString(), "1")
	end,
	BugReport = function ()
		...
		slot0:BugReport(slot5, BundleWizard.Inst:GetGroupMgr("DEFAULT_RES").CurrentVersion:ToString(), slot3.id)
	end,
	...
	QueryWithProduct = function ()
		...
		slot0.QueryWithProduct(slot2, slot0(), function (slot0)
