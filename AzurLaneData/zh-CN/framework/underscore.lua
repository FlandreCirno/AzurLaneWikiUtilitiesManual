({
	...
	range = function (slot0, slot1, slot2)
		...
		return slot0.new(slot4, coroutine.wrap(function ()
...
()["funcs"].invoke = function (slot0, slot1, ...)
	...
	slot0.funcs.each(slot0, function (slot0)
		slot0[slot0](slot0, unpack(slot0[slot0], 1, slot1.len))
	end)
...
()["funcs"].unfold = function (slot0, slot1)
	if type(slot0) == "table" then
		for slot5 in slot0:iter() do
			slot0.funcs.unfold(slot5, slot1)
		end
	else
		slot1(slot0)
	end
...
()["funcs"].flatten = function (slot0)
	slot0.funcs.unfold(slot0, function (slot0)
		slot0[#slot0 + 1] = slot0
	end)
...
function slot1()
	function slot1(slot0, slot1)
		if slot1 then
			slot0 = slot0:new(slot0, true)
		end

		return slot0
	end

	for slot5, slot6 in pairs(slot0.funcs) do
		slot0[slot5] = function (slot0, ...)
			slot3, slot4 = slot0(slot0)
