...
slot4.ftp.open = function (slot0, slot1, slot2)
...
()["__index"].send = function (slot0, slot1)
	...
	slot9 = slot3.sink("close-when-done", slot0.data)

	slot0.try(slot2.pump.all(slot1.source, slot9, function (slot0, slot1)
...
slot4.ftp.genericform = function (slot0)
