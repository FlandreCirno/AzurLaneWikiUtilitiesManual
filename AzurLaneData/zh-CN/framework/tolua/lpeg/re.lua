...
slot35 = ((({
	...
	Suffix = slot5.Cf(slot5.V("Primary") * (()["space"] + "--" * (slot9 - ()["nl"])^0)^0 * ((slot5.P("+") * slot5.Cc(1, slot7.__pow) + slot5.P("*") * slot5.Cc(0, slot7.__pow) + slot5.P("?") * slot5.Cc(-1, slot7.__pow) + "^" * (slot5.Cg((slot5.C(slot5.R("09")^1) * (()["space"] + "--" * (slot9 - ()["nl"])^0)^0) / slot0 * slot5.Cc(slot18)) + slot5.Cg(slot5.C(slot5.S("+-") * slot5.R("09")^1) * slot5.Cc(slot7.__pow))) + "->" * (()["space"] + "--" * (slot9 - ()["nl"])^0)^0 * (slot5.Cg(("'" * slot5.C((slot9 - "'")^0) * "'" + "\"" * slot5.C((slot9 - "\"")^0) * "\"" + (slot5.C(slot5.R("09")^1) * (()["space"] + "--" * (slot9 - ()["nl"])^0)^0) / slot0) * slot5.Cc(slot7.__div)) + slot5.P("{}") * slot5.Cc(nil, slot5.Ct) + slot5.Cg((slot5.C(slot21) * slot5.Carg(1)) / function (slot0, slot1)
		if not (slot1 and slot1[slot0]) then
			slot0("undefined name: " .. slot0)
		end

		return slot2
	end * slot5.Cc(slot7.__div))) + "=>" * (()["space"] + "--" * (slot9 - ()["nl"])^0)^0 * slot5.Cg((slot5.C(slot21) * slot5.Carg(1)) / function (slot0, slot1)
		if not (slot1 and slot1[slot0]) then
			slot0("undefined name: " .. slot0)
		end
	...
	Primary = "(" * slot5.V("Exp") * ")" + ("'" * slot5.C((slot9 - "'")^0) * "'" + "\"" * slot5.C((slot9 - "\"")^0) * "\"") / slot6.P + ("[" * slot5.C(slot5.P("^")^-1) * slot5.Cf((("%" * slot5.C(slot21) * slot5.Carg(1)) / function (slot0, slot1)
		if not ((slot1 and slot1[slot0]) or slot0[slot0]) then
			slot1("name '" .. slot0 .. "' undefined")
		end

		return slot2
	end + slot5.Cs(slot9 * slot5.P("-") / "" * (slot9 - "]")) / slot6.R + slot5.C(slot9)) * ((("%" * slot5.C(slot21) * slot5.Carg(1)) / function (slot0, slot1)
		if not ((slot1 and slot1[slot0]) or slot0[slot0]) then
			slot1("name '" .. slot0 .. "' undefined")
		end
	...
	end * "]" + ("%" * slot5.C(slot21) * slot5.Carg(1)) / function (slot0, slot1)
		if not ((slot1 and slot1[slot0]) or slot0[slot0]) then
			slot1("name '" .. slot0 .. "' undefined")
		end

		return slot2
	end + ("{:" * (slot5.C(slot21) * ":" + slot5.Cc(nil)) * slot5.V("Exp") * ":}") / function (slot0, slot1)
		return slot0.Cg(slot1, slot0)
	end + ("=" * slot5.C(slot21)) / function (slot0)
		return slot0.Cmt(slot0:Cb(), slot0.Cmt)
	end + slot5.P("{}") / slot6.Cp + ("{~" * slot5.V("Exp") * "~}") / slot6.Cs + ("{|" * slot5.V("Exp") * "|}") / slot6.Ct + ("{" * slot5.V("Exp") * "}") / slot6.C + slot5.P(".") * slot5.Cc(slot9) + ((slot5.C(slot21) * -((()["space"] + "--" * (slot9 - ()["nl"])^0)^0 * "<-") + "<" * slot5.C(slot21) * ">") * slot5.Cb("G")) / function (slot0, slot1)
		if not slot1 then
	...
	Definition = slot5.C(slot21) * (()["space"] + "--" * (slot9 - ()["nl"])^0)^0 * "<-" * slot5.V("Exp"),
