				...
				if not slot6 then
					...
					if ((slot6 - slot6 % 8) / 8 - ((slot6 - slot6 % 8) / 8) % 8) / 8 < 3 then
						...
						if slot6 > 0 or slot8 == 5 then
							...
							slot11 = (slot8 or slot10 or (not slot9 and slot0.x64 and not slot0.a32)) and (slot21 ~= 1 or slot22 <= 127 or slot5("-0x%x", 256 - slot22)) and (slot22 < 0 or slot22 > 2147483647 or slot5("+0x%x", slot22)) and slot5("-0x%x", 4294967296.0 - slot22) and false
							slot13 = slot13 + slot21
						end
					end
...
function slot32(slot0, slot1, slot2)
	...
	slot0.stop = (slot2 and (slot1 or 0) + slot2) or #slot0.code
	slot0.imm = nil
	slot0.mrm = false
